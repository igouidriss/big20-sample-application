...
export const Table1DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="big20SampleApplicationApp.table1.delete.question">
        <Translate contentKey="big20SampleApplicationApp.table1.delete.question" interpolate={{ id: table1Entity.id }}>
