...
export const Table7DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="big20SampleApplicationApp.table7.delete.question">
        <Translate contentKey="big20SampleApplicationApp.table7.delete.question" interpolate={{ id: table7Entity.id }}>
