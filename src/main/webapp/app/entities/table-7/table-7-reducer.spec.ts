...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './table-7.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLE7_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TABLE7 actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TABLE7 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TABLE7 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TABLE7 actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TABLE7 actions', async () => {
      const arg = 42666;
