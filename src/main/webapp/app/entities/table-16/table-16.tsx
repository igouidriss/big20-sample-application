...
import { getEntities } from './table-16.reducer';
...
export const Table16 = () => {
  ...
  const table16List = useAppSelector(state => state.table16.entities);
  ...
  return (
    <div>
      <h2 id="table-16-heading" data-cy="Table16Heading">
        <Translate contentKey="big20SampleApplicationApp.table16.home.title">Table 16 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table16.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-16/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table16.home.createLabel">Create new Table 16</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {table16List && table16List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table16.revenuTaxeExtraGlobal310">
            ...
            <tbody>
              {table16List.map((table16, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/table-16/${table16.id}`} color="link" size="sm">
                      {table16.id}
                    </Button>
                  </td>
                  <td>{table16.numLigne1}</td>
                  <td>{table16.resort2}</td>
                  <td>{table16.resvNameId3}</td>
                  <td>{table16.clientOId4}</td>
                  <td>{table16.typeChb5}</td>
                  <td>{table16.confirmationNo6}</td>
                  <td>{table16.clientMdmId7}</td>
                  <td>{table16.nameId8}</td>
                  <td>{table16.parentResvNameId9}</td>
                  <td>{table16.contactId10}</td>
                  <td>{table16.agenceId11}</td>
                  <td>{table16.agenceNom12}</td>
                  <td>{table16.societeId13}</td>
                  <td>{table16.groupeId14}</td>
                  <td>{table16.numBloc15}</td>
                  <td>{table16.typeResv16}</td>
                  <td>{table16.statutResv17}</td>
                  <td>
                    {table16.dateDebutResv18 ? (
                      <TextFormat type="date" value={table16.dateDebutResv18} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateFinResv19 ? <TextFormat type="date" value={table16.dateFinResv19} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {table16.truncDateDebutResv20 ? (
                      <TextFormat type="date" value={table16.truncDateDebutResv20} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.truncDateFinResv21 ? (
                      <TextFormat type="date" value={table16.truncDateFinResv21} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateAnnResv22 ? <TextFormat type="date" value={table16.dateAnnResv22} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table16.pseudoRoomYn23}</td>
                  <td>{table16.createurResv24}</td>
                  <td>{table16.nomCreateurResv25}</td>
                  <td>{table16.codeGarantie26}</td>
                  <td>{table16.flgDed27}</td>
                  <td>{table16.codePays28}</td>
                  <td>{table16.libPays29}</td>
                  <td>{table16.codeNationalite30}</td>
                  <td>{table16.libNationalite31}</td>
                  <td>{table16.codeSource32}</td>
                  <td>{table16.libSource33}</td>
                  <td>{table16.codeGrandSource34}</td>
                  <td>{table16.codeOrigine35}</td>
                  <td>{table16.libOrigine36}</td>
                  <td>{table16.codeMarche37}</td>
                  <td>{table16.libMarche38}</td>
                  <td>{table16.codeGrandMarche39}</td>
                  <td>{table16.libGrandMarche40}</td>
                  <td>{table16.codePrix41}</td>
                  <td>{table16.categPrix42}</td>
                  <td>{table16.libPrix43}</td>
                  <td>{table16.numChb44}</td>
                  <td>{table16.descriptionTypeChb45}</td>
                  <td>{table16.codeTypeChb46}</td>
                  <td>{table16.classChb47}</td>
                  <td>{table16.caractChb48}</td>
                  <td>{table16.typeChbDeReservation49}</td>
                  <td>{table16.descriptionTypeChbDeResv50}</td>
                  <td>{table16.codeTypeChbDeResv51}</td>
                  <td>{table16.statutDeReservation52}</td>
                  <td>{table16.circuitDistribution53}</td>
                  <td>{table16.circuitDistribUserRegroup54}</td>
                  <td>{table16.numCrs55}</td>
                  <td>{table16.typeRefCrs56}</td>
                  <td>
                    {table16.crsInsertDate57 ? (
                      <TextFormat type="date" value={table16.crsInsertDate57} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateCreaResv58 ? (
                      <TextFormat type="date" value={table16.dateCreaResv58} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.datePremier59 ? <TextFormat type="date" value={table16.datePremier59} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table16.statutPremier60}</td>
                  <td>
                    {table16.dateDernier61 ? <TextFormat type="date" value={table16.dateDernier61} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table16.statutDernier62}</td>
                  <td>
                    {table16.dateDernierPseudo63 ? (
                      <TextFormat type="date" value={table16.dateDernierPseudo63} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.statutDernierPseudo64}</td>
                  <td>{table16.diffDtCreaAnn65}</td>
                  <td>{table16.diffDtArrAnn66}</td>
                  <td>{table16.leadtime67}</td>
                  <td>{table16.los68}</td>
                  <td>{table16.occupantsGroupe69}</td>
                  <td>{table16.nbNuitee70}</td>
                  <td>{table16.nbNuiteeNnDed71}</td>
                  <td>{table16.nbResvAnn72}</td>
                  <td>{table16.nbAdu73}</td>
                  <td>{table16.nbEnf74}</td>
                  <td>{table16.nbPersDayU75}</td>
                  <td>{table16.nbPersArr76}</td>
                  <td>{table16.nbPersDep77}</td>
                  <td>{table16.nbPersAnn78}</td>
                  <td>{table16.nbPersNoshow79}</td>
                  <td>{table16.nbChbDayU80}</td>
                  <td>{table16.nbChbArr81}</td>
                  <td>{table16.nbChbDep82}</td>
                  <td>{table16.nbChbAnn83}</td>
                  <td>{table16.nbChbNoshow84}</td>
                  <td>{table16.revenuNetChambre85}</td>
                  <td>{table16.revenuTaxeChambre86}</td>
                  <td>{table16.revenuNetChambreGlobal87}</td>
                  <td>{table16.revenuTaxeChambreGlobal88}</td>
                  <td>{table16.revenuNetBq89}</td>
                  <td>{table16.revenuTaxeBq90}</td>
                  <td>{table16.revenuNetBqGlobal91}</td>
                  <td>{table16.revenuTaxeBqGlobal92}</td>
                  <td>{table16.revenuNetExtra93}</td>
                  <td>{table16.revenuTaxeExtra94}</td>
                  <td>{table16.revenuNetExtraGlobal95}</td>
                  <td>{table16.revenuTaxeExtraGlobal96}</td>
                  <td>{table16.revenuNetTotal97}</td>
                  <td>{table16.revenuTaxeTotal98}</td>
                  <td>{table16.revenuNetTotalGlobal99}</td>
                  <td>{table16.revenuTaxeTotalGlobal100}</td>
                  <td>{table16.prodRevenuChambre101}</td>
                  <td>{table16.prodRevenuBq102}</td>
                  <td>{table16.prodRevenuExtra103}</td>
                  <td>{table16.prodRevenuTotal104}</td>
                  <td>{table16.prodChambreNbNuitees105}</td>
                  <td>
                    {table16.techCreateDate106 ? (
                      <TextFormat type="date" value={table16.techCreateDate106} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.techUpdateDate107 ? (
                      <TextFormat type="date" value={table16.techUpdateDate107} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.numLigne108}</td>
                  <td>{table16.resort109}</td>
                  <td>{table16.resvNameId110}</td>
                  <td>{table16.clientOId111}</td>
                  <td>{table16.typeChb112}</td>
                  <td>{table16.confirmationNo113}</td>
                  <td>{table16.clientMdmId114}</td>
                  <td>{table16.nameId115}</td>
                  <td>{table16.parentResvNameId116}</td>
                  <td>{table16.contactId117}</td>
                  <td>{table16.agenceId118}</td>
                  <td>{table16.agenceNom119}</td>
                  <td>{table16.societeId120}</td>
                  <td>{table16.groupeId121}</td>
                  <td>{table16.numBloc122}</td>
                  <td>{table16.typeResv123}</td>
                  <td>{table16.statutResv124}</td>
                  <td>
                    {table16.dateDebutResv125 ? (
                      <TextFormat type="date" value={table16.dateDebutResv125} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateFinResv126 ? (
                      <TextFormat type="date" value={table16.dateFinResv126} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.truncDateDebutResv127 ? (
                      <TextFormat type="date" value={table16.truncDateDebutResv127} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.truncDateFinResv128 ? (
                      <TextFormat type="date" value={table16.truncDateFinResv128} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateAnnResv129 ? (
                      <TextFormat type="date" value={table16.dateAnnResv129} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.pseudoRoomYn130}</td>
                  <td>{table16.createurResv131}</td>
                  <td>{table16.nomCreateurResv132}</td>
                  <td>{table16.codeGarantie133}</td>
                  <td>{table16.flgDed134}</td>
                  <td>{table16.codePays135}</td>
                  <td>{table16.libPays136}</td>
                  <td>{table16.codeNationalite137}</td>
                  <td>{table16.libNationalite138}</td>
                  <td>{table16.codeSource139}</td>
                  <td>{table16.libSource140}</td>
                  <td>{table16.codeGrandSource141}</td>
                  <td>{table16.codeOrigine142}</td>
                  <td>{table16.libOrigine143}</td>
                  <td>{table16.codeMarche144}</td>
                  <td>{table16.libMarche145}</td>
                  <td>{table16.codeGrandMarche146}</td>
                  <td>{table16.libGrandMarche147}</td>
                  <td>{table16.codePrix148}</td>
                  <td>{table16.categPrix149}</td>
                  <td>{table16.libPrix150}</td>
                  <td>{table16.numChb151}</td>
                  <td>{table16.descriptionTypeChb152}</td>
                  <td>{table16.codeTypeChb153}</td>
                  <td>{table16.classChb154}</td>
                  <td>{table16.caractChb155}</td>
                  <td>{table16.typeChbDeReservation156}</td>
                  <td>{table16.descriptionTypeChbDeResv157}</td>
                  <td>{table16.codeTypeChbDeResv158}</td>
                  <td>{table16.statutDeReservation159}</td>
                  <td>{table16.circuitDistribution160}</td>
                  <td>{table16.circuitDistribUserRegroup161}</td>
                  <td>{table16.numCrs162}</td>
                  <td>{table16.typeRefCrs163}</td>
                  <td>
                    {table16.crsInsertDate164 ? (
                      <TextFormat type="date" value={table16.crsInsertDate164} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateCreaResv165 ? (
                      <TextFormat type="date" value={table16.dateCreaResv165} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.datePremier166 ? (
                      <TextFormat type="date" value={table16.datePremier166} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.statutPremier167}</td>
                  <td>
                    {table16.dateDernier168 ? (
                      <TextFormat type="date" value={table16.dateDernier168} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.statutDernier169}</td>
                  <td>
                    {table16.dateDernierPseudo170 ? (
                      <TextFormat type="date" value={table16.dateDernierPseudo170} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.statutDernierPseudo171}</td>
                  <td>{table16.diffDtCreaAnn172}</td>
                  <td>{table16.diffDtArrAnn173}</td>
                  <td>{table16.leadtime174}</td>
                  <td>{table16.los175}</td>
                  <td>{table16.occupantsGroupe176}</td>
                  <td>{table16.nbNuitee177}</td>
                  <td>{table16.nbNuiteeNnDed178}</td>
                  <td>{table16.nbResvAnn179}</td>
                  <td>{table16.nbAdu180}</td>
                  <td>{table16.nbEnf181}</td>
                  <td>{table16.nbPersDayU182}</td>
                  <td>{table16.nbPersArr183}</td>
                  <td>{table16.nbPersDep184}</td>
                  <td>{table16.nbPersAnn185}</td>
                  <td>{table16.nbPersNoshow186}</td>
                  <td>{table16.nbChbDayU187}</td>
                  <td>{table16.nbChbArr188}</td>
                  <td>{table16.nbChbDep189}</td>
                  <td>{table16.nbChbAnn190}</td>
                  <td>{table16.nbChbNoshow191}</td>
                  <td>{table16.revenuNetChambre192}</td>
                  <td>{table16.revenuTaxeChambre193}</td>
                  <td>{table16.revenuNetChambreGlobal194}</td>
                  <td>{table16.revenuTaxeChambreGlobal195}</td>
                  <td>{table16.revenuNetBq196}</td>
                  <td>{table16.revenuTaxeBq197}</td>
                  <td>{table16.revenuNetBqGlobal198}</td>
                  <td>{table16.revenuTaxeBqGlobal199}</td>
                  <td>{table16.revenuNetExtra200}</td>
                  <td>{table16.revenuTaxeExtra201}</td>
                  <td>{table16.revenuNetExtraGlobal202}</td>
                  <td>{table16.revenuTaxeExtraGlobal203}</td>
                  <td>{table16.revenuNetTotal204}</td>
                  <td>{table16.revenuTaxeTotal205}</td>
                  <td>{table16.revenuNetTotalGlobal206}</td>
                  <td>{table16.revenuTaxeTotalGlobal207}</td>
                  <td>{table16.prodRevenuChambre208}</td>
                  <td>{table16.prodRevenuBq209}</td>
                  <td>{table16.prodRevenuExtra210}</td>
                  <td>{table16.prodRevenuTotal211}</td>
                  <td>{table16.prodChambreNbNuitees212}</td>
                  <td>
                    {table16.techCreateDate213 ? (
                      <TextFormat type="date" value={table16.techCreateDate213} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.techUpdateDate214 ? (
                      <TextFormat type="date" value={table16.techUpdateDate214} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.numLigne215}</td>
                  <td>{table16.resort216}</td>
                  <td>{table16.resvNameId217}</td>
                  <td>{table16.clientOId218}</td>
                  <td>{table16.typeChb219}</td>
                  <td>{table16.confirmationNo220}</td>
                  <td>{table16.clientMdmId221}</td>
                  <td>{table16.nameId222}</td>
                  <td>{table16.parentResvNameId223}</td>
                  <td>{table16.contactId224}</td>
                  <td>{table16.agenceId225}</td>
                  <td>{table16.agenceNom226}</td>
                  <td>{table16.societeId227}</td>
                  <td>{table16.groupeId228}</td>
                  <td>{table16.numBloc229}</td>
                  <td>{table16.typeResv230}</td>
                  <td>{table16.statutResv231}</td>
                  <td>
                    {table16.dateDebutResv232 ? (
                      <TextFormat type="date" value={table16.dateDebutResv232} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateFinResv233 ? (
                      <TextFormat type="date" value={table16.dateFinResv233} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.truncDateDebutResv234 ? (
                      <TextFormat type="date" value={table16.truncDateDebutResv234} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.truncDateFinResv235 ? (
                      <TextFormat type="date" value={table16.truncDateFinResv235} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateAnnResv236 ? (
                      <TextFormat type="date" value={table16.dateAnnResv236} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.pseudoRoomYn237}</td>
                  <td>{table16.createurResv238}</td>
                  <td>{table16.nomCreateurResv239}</td>
                  <td>{table16.codeGarantie240}</td>
                  <td>{table16.flgDed241}</td>
                  <td>{table16.codePays242}</td>
                  <td>{table16.libPays243}</td>
                  <td>{table16.codeNationalite244}</td>
                  <td>{table16.libNationalite245}</td>
                  <td>{table16.codeSource246}</td>
                  <td>{table16.libSource247}</td>
                  <td>{table16.codeGrandSource248}</td>
                  <td>{table16.codeOrigine249}</td>
                  <td>{table16.libOrigine250}</td>
                  <td>{table16.codeMarche251}</td>
                  <td>{table16.libMarche252}</td>
                  <td>{table16.codeGrandMarche253}</td>
                  <td>{table16.libGrandMarche254}</td>
                  <td>{table16.codePrix255}</td>
                  <td>{table16.categPrix256}</td>
                  <td>{table16.libPrix257}</td>
                  <td>{table16.numChb258}</td>
                  <td>{table16.descriptionTypeChb259}</td>
                  <td>{table16.codeTypeChb260}</td>
                  <td>{table16.classChb261}</td>
                  <td>{table16.caractChb262}</td>
                  <td>{table16.typeChbDeReservation263}</td>
                  <td>{table16.descriptionTypeChbDeResv264}</td>
                  <td>{table16.codeTypeChbDeResv265}</td>
                  <td>{table16.statutDeReservation266}</td>
                  <td>{table16.circuitDistribution267}</td>
                  <td>{table16.circuitDistribUserRegroup268}</td>
                  <td>{table16.numCrs269}</td>
                  <td>{table16.typeRefCrs270}</td>
                  <td>
                    {table16.crsInsertDate271 ? (
                      <TextFormat type="date" value={table16.crsInsertDate271} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.dateCreaResv272 ? (
                      <TextFormat type="date" value={table16.dateCreaResv272} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table16.datePremier273 ? (
                      <TextFormat type="date" value={table16.datePremier273} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.statutPremier274}</td>
                  <td>
                    {table16.dateDernier275 ? (
                      <TextFormat type="date" value={table16.dateDernier275} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.statutDernier276}</td>
                  <td>
                    {table16.dateDernierPseudo277 ? (
                      <TextFormat type="date" value={table16.dateDernierPseudo277} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table16.statutDernierPseudo278}</td>
                  <td>{table16.diffDtCreaAnn279}</td>
                  <td>{table16.diffDtArrAnn280}</td>
                  <td>{table16.leadtime281}</td>
                  <td>{table16.los282}</td>
                  <td>{table16.occupantsGroupe283}</td>
                  <td>{table16.nbNuitee284}</td>
                  <td>{table16.nbNuiteeNnDed285}</td>
                  <td>{table16.nbResvAnn286}</td>
                  <td>{table16.nbAdu287}</td>
                  <td>{table16.nbEnf288}</td>
                  <td>{table16.nbPersDayU289}</td>
                  <td>{table16.nbPersArr290}</td>
                  <td>{table16.nbPersDep291}</td>
                  <td>{table16.nbPersAnn292}</td>
                  <td>{table16.nbPersNoshow293}</td>
                  <td>{table16.nbChbDayU294}</td>
                  <td>{table16.nbChbArr295}</td>
                  <td>{table16.nbChbDep296}</td>
                  <td>{table16.nbChbAnn297}</td>
                  <td>{table16.nbChbNoshow298}</td>
                  <td>{table16.revenuNetChambre299}</td>
                  <td>{table16.revenuTaxeChambre300}</td>
                  <td>{table16.revenuNetChambreGlobal301}</td>
                  <td>{table16.revenuTaxeChambreGlobal302}</td>
                  <td>{table16.revenuNetBq303}</td>
                  <td>{table16.revenuTaxeBq304}</td>
                  <td>{table16.revenuNetBqGlobal305}</td>
                  <td>{table16.revenuTaxeBqGlobal306}</td>
                  <td>{table16.revenuNetExtra307}</td>
                  <td>{table16.revenuTaxeExtra308}</td>
                  <td>{table16.revenuNetExtraGlobal309}</td>
                  <td>{table16.revenuTaxeExtraGlobal310}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/table-16/${table16.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/table-16/${table16.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/table-16/${table16.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table16.home.notFound">No Table 16 S found</Translate>
            </div>
          )
        )}
      </div>
