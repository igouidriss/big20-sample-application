...
import { getEntities } from './table-19.reducer';
...
export const Table19 = () => {
  ...
  const table19List = useAppSelector(state => state.table19.entities);
  ...
  return (
    <div>
      <h2 id="table-19-heading" data-cy="Table19Heading">
        <Translate contentKey="big20SampleApplicationApp.table19.home.title">Table 19 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table19.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-19/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table19.home.createLabel">Create new Table 19</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {table19List && table19List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table19.revenuTaxeExtraGlobal310">
            ...
            <tbody>
              {table19List.map((table19, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/table-19/${table19.id}`} color="link" size="sm">
                      {table19.id}
                    </Button>
                  </td>
                  <td>{table19.numLigne1}</td>
                  <td>{table19.resort2}</td>
                  <td>{table19.resvNameId3}</td>
                  <td>{table19.clientOId4}</td>
                  <td>{table19.typeChb5}</td>
                  <td>{table19.confirmationNo6}</td>
                  <td>{table19.clientMdmId7}</td>
                  <td>{table19.nameId8}</td>
                  <td>{table19.parentResvNameId9}</td>
                  <td>{table19.contactId10}</td>
                  <td>{table19.agenceId11}</td>
                  <td>{table19.agenceNom12}</td>
                  <td>{table19.societeId13}</td>
                  <td>{table19.groupeId14}</td>
                  <td>{table19.numBloc15}</td>
                  <td>{table19.typeResv16}</td>
                  <td>{table19.statutResv17}</td>
                  <td>
                    {table19.dateDebutResv18 ? (
                      <TextFormat type="date" value={table19.dateDebutResv18} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateFinResv19 ? <TextFormat type="date" value={table19.dateFinResv19} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {table19.truncDateDebutResv20 ? (
                      <TextFormat type="date" value={table19.truncDateDebutResv20} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.truncDateFinResv21 ? (
                      <TextFormat type="date" value={table19.truncDateFinResv21} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateAnnResv22 ? <TextFormat type="date" value={table19.dateAnnResv22} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table19.pseudoRoomYn23}</td>
                  <td>{table19.createurResv24}</td>
                  <td>{table19.nomCreateurResv25}</td>
                  <td>{table19.codeGarantie26}</td>
                  <td>{table19.flgDed27}</td>
                  <td>{table19.codePays28}</td>
                  <td>{table19.libPays29}</td>
                  <td>{table19.codeNationalite30}</td>
                  <td>{table19.libNationalite31}</td>
                  <td>{table19.codeSource32}</td>
                  <td>{table19.libSource33}</td>
                  <td>{table19.codeGrandSource34}</td>
                  <td>{table19.codeOrigine35}</td>
                  <td>{table19.libOrigine36}</td>
                  <td>{table19.codeMarche37}</td>
                  <td>{table19.libMarche38}</td>
                  <td>{table19.codeGrandMarche39}</td>
                  <td>{table19.libGrandMarche40}</td>
                  <td>{table19.codePrix41}</td>
                  <td>{table19.categPrix42}</td>
                  <td>{table19.libPrix43}</td>
                  <td>{table19.numChb44}</td>
                  <td>{table19.descriptionTypeChb45}</td>
                  <td>{table19.codeTypeChb46}</td>
                  <td>{table19.classChb47}</td>
                  <td>{table19.caractChb48}</td>
                  <td>{table19.typeChbDeReservation49}</td>
                  <td>{table19.descriptionTypeChbDeResv50}</td>
                  <td>{table19.codeTypeChbDeResv51}</td>
                  <td>{table19.statutDeReservation52}</td>
                  <td>{table19.circuitDistribution53}</td>
                  <td>{table19.circuitDistribUserRegroup54}</td>
                  <td>{table19.numCrs55}</td>
                  <td>{table19.typeRefCrs56}</td>
                  <td>
                    {table19.crsInsertDate57 ? (
                      <TextFormat type="date" value={table19.crsInsertDate57} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateCreaResv58 ? (
                      <TextFormat type="date" value={table19.dateCreaResv58} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.datePremier59 ? <TextFormat type="date" value={table19.datePremier59} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table19.statutPremier60}</td>
                  <td>
                    {table19.dateDernier61 ? <TextFormat type="date" value={table19.dateDernier61} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table19.statutDernier62}</td>
                  <td>
                    {table19.dateDernierPseudo63 ? (
                      <TextFormat type="date" value={table19.dateDernierPseudo63} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.statutDernierPseudo64}</td>
                  <td>{table19.diffDtCreaAnn65}</td>
                  <td>{table19.diffDtArrAnn66}</td>
                  <td>{table19.leadtime67}</td>
                  <td>{table19.los68}</td>
                  <td>{table19.occupantsGroupe69}</td>
                  <td>{table19.nbNuitee70}</td>
                  <td>{table19.nbNuiteeNnDed71}</td>
                  <td>{table19.nbResvAnn72}</td>
                  <td>{table19.nbAdu73}</td>
                  <td>{table19.nbEnf74}</td>
                  <td>{table19.nbPersDayU75}</td>
                  <td>{table19.nbPersArr76}</td>
                  <td>{table19.nbPersDep77}</td>
                  <td>{table19.nbPersAnn78}</td>
                  <td>{table19.nbPersNoshow79}</td>
                  <td>{table19.nbChbDayU80}</td>
                  <td>{table19.nbChbArr81}</td>
                  <td>{table19.nbChbDep82}</td>
                  <td>{table19.nbChbAnn83}</td>
                  <td>{table19.nbChbNoshow84}</td>
                  <td>{table19.revenuNetChambre85}</td>
                  <td>{table19.revenuTaxeChambre86}</td>
                  <td>{table19.revenuNetChambreGlobal87}</td>
                  <td>{table19.revenuTaxeChambreGlobal88}</td>
                  <td>{table19.revenuNetBq89}</td>
                  <td>{table19.revenuTaxeBq90}</td>
                  <td>{table19.revenuNetBqGlobal91}</td>
                  <td>{table19.revenuTaxeBqGlobal92}</td>
                  <td>{table19.revenuNetExtra93}</td>
                  <td>{table19.revenuTaxeExtra94}</td>
                  <td>{table19.revenuNetExtraGlobal95}</td>
                  <td>{table19.revenuTaxeExtraGlobal96}</td>
                  <td>{table19.revenuNetTotal97}</td>
                  <td>{table19.revenuTaxeTotal98}</td>
                  <td>{table19.revenuNetTotalGlobal99}</td>
                  <td>{table19.revenuTaxeTotalGlobal100}</td>
                  <td>{table19.prodRevenuChambre101}</td>
                  <td>{table19.prodRevenuBq102}</td>
                  <td>{table19.prodRevenuExtra103}</td>
                  <td>{table19.prodRevenuTotal104}</td>
                  <td>{table19.prodChambreNbNuitees105}</td>
                  <td>
                    {table19.techCreateDate106 ? (
                      <TextFormat type="date" value={table19.techCreateDate106} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.techUpdateDate107 ? (
                      <TextFormat type="date" value={table19.techUpdateDate107} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.numLigne108}</td>
                  <td>{table19.resort109}</td>
                  <td>{table19.resvNameId110}</td>
                  <td>{table19.clientOId111}</td>
                  <td>{table19.typeChb112}</td>
                  <td>{table19.confirmationNo113}</td>
                  <td>{table19.clientMdmId114}</td>
                  <td>{table19.nameId115}</td>
                  <td>{table19.parentResvNameId116}</td>
                  <td>{table19.contactId117}</td>
                  <td>{table19.agenceId118}</td>
                  <td>{table19.agenceNom119}</td>
                  <td>{table19.societeId120}</td>
                  <td>{table19.groupeId121}</td>
                  <td>{table19.numBloc122}</td>
                  <td>{table19.typeResv123}</td>
                  <td>{table19.statutResv124}</td>
                  <td>
                    {table19.dateDebutResv125 ? (
                      <TextFormat type="date" value={table19.dateDebutResv125} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateFinResv126 ? (
                      <TextFormat type="date" value={table19.dateFinResv126} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.truncDateDebutResv127 ? (
                      <TextFormat type="date" value={table19.truncDateDebutResv127} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.truncDateFinResv128 ? (
                      <TextFormat type="date" value={table19.truncDateFinResv128} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateAnnResv129 ? (
                      <TextFormat type="date" value={table19.dateAnnResv129} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.pseudoRoomYn130}</td>
                  <td>{table19.createurResv131}</td>
                  <td>{table19.nomCreateurResv132}</td>
                  <td>{table19.codeGarantie133}</td>
                  <td>{table19.flgDed134}</td>
                  <td>{table19.codePays135}</td>
                  <td>{table19.libPays136}</td>
                  <td>{table19.codeNationalite137}</td>
                  <td>{table19.libNationalite138}</td>
                  <td>{table19.codeSource139}</td>
                  <td>{table19.libSource140}</td>
                  <td>{table19.codeGrandSource141}</td>
                  <td>{table19.codeOrigine142}</td>
                  <td>{table19.libOrigine143}</td>
                  <td>{table19.codeMarche144}</td>
                  <td>{table19.libMarche145}</td>
                  <td>{table19.codeGrandMarche146}</td>
                  <td>{table19.libGrandMarche147}</td>
                  <td>{table19.codePrix148}</td>
                  <td>{table19.categPrix149}</td>
                  <td>{table19.libPrix150}</td>
                  <td>{table19.numChb151}</td>
                  <td>{table19.descriptionTypeChb152}</td>
                  <td>{table19.codeTypeChb153}</td>
                  <td>{table19.classChb154}</td>
                  <td>{table19.caractChb155}</td>
                  <td>{table19.typeChbDeReservation156}</td>
                  <td>{table19.descriptionTypeChbDeResv157}</td>
                  <td>{table19.codeTypeChbDeResv158}</td>
                  <td>{table19.statutDeReservation159}</td>
                  <td>{table19.circuitDistribution160}</td>
                  <td>{table19.circuitDistribUserRegroup161}</td>
                  <td>{table19.numCrs162}</td>
                  <td>{table19.typeRefCrs163}</td>
                  <td>
                    {table19.crsInsertDate164 ? (
                      <TextFormat type="date" value={table19.crsInsertDate164} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateCreaResv165 ? (
                      <TextFormat type="date" value={table19.dateCreaResv165} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.datePremier166 ? (
                      <TextFormat type="date" value={table19.datePremier166} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.statutPremier167}</td>
                  <td>
                    {table19.dateDernier168 ? (
                      <TextFormat type="date" value={table19.dateDernier168} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.statutDernier169}</td>
                  <td>
                    {table19.dateDernierPseudo170 ? (
                      <TextFormat type="date" value={table19.dateDernierPseudo170} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.statutDernierPseudo171}</td>
                  <td>{table19.diffDtCreaAnn172}</td>
                  <td>{table19.diffDtArrAnn173}</td>
                  <td>{table19.leadtime174}</td>
                  <td>{table19.los175}</td>
                  <td>{table19.occupantsGroupe176}</td>
                  <td>{table19.nbNuitee177}</td>
                  <td>{table19.nbNuiteeNnDed178}</td>
                  <td>{table19.nbResvAnn179}</td>
                  <td>{table19.nbAdu180}</td>
                  <td>{table19.nbEnf181}</td>
                  <td>{table19.nbPersDayU182}</td>
                  <td>{table19.nbPersArr183}</td>
                  <td>{table19.nbPersDep184}</td>
                  <td>{table19.nbPersAnn185}</td>
                  <td>{table19.nbPersNoshow186}</td>
                  <td>{table19.nbChbDayU187}</td>
                  <td>{table19.nbChbArr188}</td>
                  <td>{table19.nbChbDep189}</td>
                  <td>{table19.nbChbAnn190}</td>
                  <td>{table19.nbChbNoshow191}</td>
                  <td>{table19.revenuNetChambre192}</td>
                  <td>{table19.revenuTaxeChambre193}</td>
                  <td>{table19.revenuNetChambreGlobal194}</td>
                  <td>{table19.revenuTaxeChambreGlobal195}</td>
                  <td>{table19.revenuNetBq196}</td>
                  <td>{table19.revenuTaxeBq197}</td>
                  <td>{table19.revenuNetBqGlobal198}</td>
                  <td>{table19.revenuTaxeBqGlobal199}</td>
                  <td>{table19.revenuNetExtra200}</td>
                  <td>{table19.revenuTaxeExtra201}</td>
                  <td>{table19.revenuNetExtraGlobal202}</td>
                  <td>{table19.revenuTaxeExtraGlobal203}</td>
                  <td>{table19.revenuNetTotal204}</td>
                  <td>{table19.revenuTaxeTotal205}</td>
                  <td>{table19.revenuNetTotalGlobal206}</td>
                  <td>{table19.revenuTaxeTotalGlobal207}</td>
                  <td>{table19.prodRevenuChambre208}</td>
                  <td>{table19.prodRevenuBq209}</td>
                  <td>{table19.prodRevenuExtra210}</td>
                  <td>{table19.prodRevenuTotal211}</td>
                  <td>{table19.prodChambreNbNuitees212}</td>
                  <td>
                    {table19.techCreateDate213 ? (
                      <TextFormat type="date" value={table19.techCreateDate213} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.techUpdateDate214 ? (
                      <TextFormat type="date" value={table19.techUpdateDate214} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.numLigne215}</td>
                  <td>{table19.resort216}</td>
                  <td>{table19.resvNameId217}</td>
                  <td>{table19.clientOId218}</td>
                  <td>{table19.typeChb219}</td>
                  <td>{table19.confirmationNo220}</td>
                  <td>{table19.clientMdmId221}</td>
                  <td>{table19.nameId222}</td>
                  <td>{table19.parentResvNameId223}</td>
                  <td>{table19.contactId224}</td>
                  <td>{table19.agenceId225}</td>
                  <td>{table19.agenceNom226}</td>
                  <td>{table19.societeId227}</td>
                  <td>{table19.groupeId228}</td>
                  <td>{table19.numBloc229}</td>
                  <td>{table19.typeResv230}</td>
                  <td>{table19.statutResv231}</td>
                  <td>
                    {table19.dateDebutResv232 ? (
                      <TextFormat type="date" value={table19.dateDebutResv232} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateFinResv233 ? (
                      <TextFormat type="date" value={table19.dateFinResv233} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.truncDateDebutResv234 ? (
                      <TextFormat type="date" value={table19.truncDateDebutResv234} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.truncDateFinResv235 ? (
                      <TextFormat type="date" value={table19.truncDateFinResv235} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateAnnResv236 ? (
                      <TextFormat type="date" value={table19.dateAnnResv236} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.pseudoRoomYn237}</td>
                  <td>{table19.createurResv238}</td>
                  <td>{table19.nomCreateurResv239}</td>
                  <td>{table19.codeGarantie240}</td>
                  <td>{table19.flgDed241}</td>
                  <td>{table19.codePays242}</td>
                  <td>{table19.libPays243}</td>
                  <td>{table19.codeNationalite244}</td>
                  <td>{table19.libNationalite245}</td>
                  <td>{table19.codeSource246}</td>
                  <td>{table19.libSource247}</td>
                  <td>{table19.codeGrandSource248}</td>
                  <td>{table19.codeOrigine249}</td>
                  <td>{table19.libOrigine250}</td>
                  <td>{table19.codeMarche251}</td>
                  <td>{table19.libMarche252}</td>
                  <td>{table19.codeGrandMarche253}</td>
                  <td>{table19.libGrandMarche254}</td>
                  <td>{table19.codePrix255}</td>
                  <td>{table19.categPrix256}</td>
                  <td>{table19.libPrix257}</td>
                  <td>{table19.numChb258}</td>
                  <td>{table19.descriptionTypeChb259}</td>
                  <td>{table19.codeTypeChb260}</td>
                  <td>{table19.classChb261}</td>
                  <td>{table19.caractChb262}</td>
                  <td>{table19.typeChbDeReservation263}</td>
                  <td>{table19.descriptionTypeChbDeResv264}</td>
                  <td>{table19.codeTypeChbDeResv265}</td>
                  <td>{table19.statutDeReservation266}</td>
                  <td>{table19.circuitDistribution267}</td>
                  <td>{table19.circuitDistribUserRegroup268}</td>
                  <td>{table19.numCrs269}</td>
                  <td>{table19.typeRefCrs270}</td>
                  <td>
                    {table19.crsInsertDate271 ? (
                      <TextFormat type="date" value={table19.crsInsertDate271} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.dateCreaResv272 ? (
                      <TextFormat type="date" value={table19.dateCreaResv272} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table19.datePremier273 ? (
                      <TextFormat type="date" value={table19.datePremier273} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.statutPremier274}</td>
                  <td>
                    {table19.dateDernier275 ? (
                      <TextFormat type="date" value={table19.dateDernier275} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.statutDernier276}</td>
                  <td>
                    {table19.dateDernierPseudo277 ? (
                      <TextFormat type="date" value={table19.dateDernierPseudo277} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table19.statutDernierPseudo278}</td>
                  <td>{table19.diffDtCreaAnn279}</td>
                  <td>{table19.diffDtArrAnn280}</td>
                  <td>{table19.leadtime281}</td>
                  <td>{table19.los282}</td>
                  <td>{table19.occupantsGroupe283}</td>
                  <td>{table19.nbNuitee284}</td>
                  <td>{table19.nbNuiteeNnDed285}</td>
                  <td>{table19.nbResvAnn286}</td>
                  <td>{table19.nbAdu287}</td>
                  <td>{table19.nbEnf288}</td>
                  <td>{table19.nbPersDayU289}</td>
                  <td>{table19.nbPersArr290}</td>
                  <td>{table19.nbPersDep291}</td>
                  <td>{table19.nbPersAnn292}</td>
                  <td>{table19.nbPersNoshow293}</td>
                  <td>{table19.nbChbDayU294}</td>
                  <td>{table19.nbChbArr295}</td>
                  <td>{table19.nbChbDep296}</td>
                  <td>{table19.nbChbAnn297}</td>
                  <td>{table19.nbChbNoshow298}</td>
                  <td>{table19.revenuNetChambre299}</td>
                  <td>{table19.revenuTaxeChambre300}</td>
                  <td>{table19.revenuNetChambreGlobal301}</td>
                  <td>{table19.revenuTaxeChambreGlobal302}</td>
                  <td>{table19.revenuNetBq303}</td>
                  <td>{table19.revenuTaxeBq304}</td>
                  <td>{table19.revenuNetBqGlobal305}</td>
                  <td>{table19.revenuTaxeBqGlobal306}</td>
                  <td>{table19.revenuNetExtra307}</td>
                  <td>{table19.revenuTaxeExtra308}</td>
                  <td>{table19.revenuNetExtraGlobal309}</td>
                  <td>{table19.revenuTaxeExtraGlobal310}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/table-19/${table19.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/table-19/${table19.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/table-19/${table19.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table19.home.notFound">No Table 19 S found</Translate>
            </div>
          )
        )}
      </div>
