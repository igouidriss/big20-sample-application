...
import { getEntities } from './table-18.reducer';
...
export const Table18 = () => {
  ...
  const table18List = useAppSelector(state => state.table18.entities);
  ...
  return (
    <div>
      <h2 id="table-18-heading" data-cy="Table18Heading">
        <Translate contentKey="big20SampleApplicationApp.table18.home.title">Table 18 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table18.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-18/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table18.home.createLabel">Create new Table 18</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {table18List && table18List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table18.revenuTaxeExtraGlobal310">
            ...
            <tbody>
              {table18List.map((table18, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/table-18/${table18.id}`} color="link" size="sm">
                      {table18.id}
                    </Button>
                  </td>
                  <td>{table18.numLigne1}</td>
                  <td>{table18.resort2}</td>
                  <td>{table18.resvNameId3}</td>
                  <td>{table18.clientOId4}</td>
                  <td>{table18.typeChb5}</td>
                  <td>{table18.confirmationNo6}</td>
                  <td>{table18.clientMdmId7}</td>
                  <td>{table18.nameId8}</td>
                  <td>{table18.parentResvNameId9}</td>
                  <td>{table18.contactId10}</td>
                  <td>{table18.agenceId11}</td>
                  <td>{table18.agenceNom12}</td>
                  <td>{table18.societeId13}</td>
                  <td>{table18.groupeId14}</td>
                  <td>{table18.numBloc15}</td>
                  <td>{table18.typeResv16}</td>
                  <td>{table18.statutResv17}</td>
                  <td>
                    {table18.dateDebutResv18 ? (
                      <TextFormat type="date" value={table18.dateDebutResv18} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateFinResv19 ? <TextFormat type="date" value={table18.dateFinResv19} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {table18.truncDateDebutResv20 ? (
                      <TextFormat type="date" value={table18.truncDateDebutResv20} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.truncDateFinResv21 ? (
                      <TextFormat type="date" value={table18.truncDateFinResv21} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateAnnResv22 ? <TextFormat type="date" value={table18.dateAnnResv22} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table18.pseudoRoomYn23}</td>
                  <td>{table18.createurResv24}</td>
                  <td>{table18.nomCreateurResv25}</td>
                  <td>{table18.codeGarantie26}</td>
                  <td>{table18.flgDed27}</td>
                  <td>{table18.codePays28}</td>
                  <td>{table18.libPays29}</td>
                  <td>{table18.codeNationalite30}</td>
                  <td>{table18.libNationalite31}</td>
                  <td>{table18.codeSource32}</td>
                  <td>{table18.libSource33}</td>
                  <td>{table18.codeGrandSource34}</td>
                  <td>{table18.codeOrigine35}</td>
                  <td>{table18.libOrigine36}</td>
                  <td>{table18.codeMarche37}</td>
                  <td>{table18.libMarche38}</td>
                  <td>{table18.codeGrandMarche39}</td>
                  <td>{table18.libGrandMarche40}</td>
                  <td>{table18.codePrix41}</td>
                  <td>{table18.categPrix42}</td>
                  <td>{table18.libPrix43}</td>
                  <td>{table18.numChb44}</td>
                  <td>{table18.descriptionTypeChb45}</td>
                  <td>{table18.codeTypeChb46}</td>
                  <td>{table18.classChb47}</td>
                  <td>{table18.caractChb48}</td>
                  <td>{table18.typeChbDeReservation49}</td>
                  <td>{table18.descriptionTypeChbDeResv50}</td>
                  <td>{table18.codeTypeChbDeResv51}</td>
                  <td>{table18.statutDeReservation52}</td>
                  <td>{table18.circuitDistribution53}</td>
                  <td>{table18.circuitDistribUserRegroup54}</td>
                  <td>{table18.numCrs55}</td>
                  <td>{table18.typeRefCrs56}</td>
                  <td>
                    {table18.crsInsertDate57 ? (
                      <TextFormat type="date" value={table18.crsInsertDate57} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateCreaResv58 ? (
                      <TextFormat type="date" value={table18.dateCreaResv58} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.datePremier59 ? <TextFormat type="date" value={table18.datePremier59} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table18.statutPremier60}</td>
                  <td>
                    {table18.dateDernier61 ? <TextFormat type="date" value={table18.dateDernier61} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table18.statutDernier62}</td>
                  <td>
                    {table18.dateDernierPseudo63 ? (
                      <TextFormat type="date" value={table18.dateDernierPseudo63} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.statutDernierPseudo64}</td>
                  <td>{table18.diffDtCreaAnn65}</td>
                  <td>{table18.diffDtArrAnn66}</td>
                  <td>{table18.leadtime67}</td>
                  <td>{table18.los68}</td>
                  <td>{table18.occupantsGroupe69}</td>
                  <td>{table18.nbNuitee70}</td>
                  <td>{table18.nbNuiteeNnDed71}</td>
                  <td>{table18.nbResvAnn72}</td>
                  <td>{table18.nbAdu73}</td>
                  <td>{table18.nbEnf74}</td>
                  <td>{table18.nbPersDayU75}</td>
                  <td>{table18.nbPersArr76}</td>
                  <td>{table18.nbPersDep77}</td>
                  <td>{table18.nbPersAnn78}</td>
                  <td>{table18.nbPersNoshow79}</td>
                  <td>{table18.nbChbDayU80}</td>
                  <td>{table18.nbChbArr81}</td>
                  <td>{table18.nbChbDep82}</td>
                  <td>{table18.nbChbAnn83}</td>
                  <td>{table18.nbChbNoshow84}</td>
                  <td>{table18.revenuNetChambre85}</td>
                  <td>{table18.revenuTaxeChambre86}</td>
                  <td>{table18.revenuNetChambreGlobal87}</td>
                  <td>{table18.revenuTaxeChambreGlobal88}</td>
                  <td>{table18.revenuNetBq89}</td>
                  <td>{table18.revenuTaxeBq90}</td>
                  <td>{table18.revenuNetBqGlobal91}</td>
                  <td>{table18.revenuTaxeBqGlobal92}</td>
                  <td>{table18.revenuNetExtra93}</td>
                  <td>{table18.revenuTaxeExtra94}</td>
                  <td>{table18.revenuNetExtraGlobal95}</td>
                  <td>{table18.revenuTaxeExtraGlobal96}</td>
                  <td>{table18.revenuNetTotal97}</td>
                  <td>{table18.revenuTaxeTotal98}</td>
                  <td>{table18.revenuNetTotalGlobal99}</td>
                  <td>{table18.revenuTaxeTotalGlobal100}</td>
                  <td>{table18.prodRevenuChambre101}</td>
                  <td>{table18.prodRevenuBq102}</td>
                  <td>{table18.prodRevenuExtra103}</td>
                  <td>{table18.prodRevenuTotal104}</td>
                  <td>{table18.prodChambreNbNuitees105}</td>
                  <td>
                    {table18.techCreateDate106 ? (
                      <TextFormat type="date" value={table18.techCreateDate106} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.techUpdateDate107 ? (
                      <TextFormat type="date" value={table18.techUpdateDate107} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.numLigne108}</td>
                  <td>{table18.resort109}</td>
                  <td>{table18.resvNameId110}</td>
                  <td>{table18.clientOId111}</td>
                  <td>{table18.typeChb112}</td>
                  <td>{table18.confirmationNo113}</td>
                  <td>{table18.clientMdmId114}</td>
                  <td>{table18.nameId115}</td>
                  <td>{table18.parentResvNameId116}</td>
                  <td>{table18.contactId117}</td>
                  <td>{table18.agenceId118}</td>
                  <td>{table18.agenceNom119}</td>
                  <td>{table18.societeId120}</td>
                  <td>{table18.groupeId121}</td>
                  <td>{table18.numBloc122}</td>
                  <td>{table18.typeResv123}</td>
                  <td>{table18.statutResv124}</td>
                  <td>
                    {table18.dateDebutResv125 ? (
                      <TextFormat type="date" value={table18.dateDebutResv125} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateFinResv126 ? (
                      <TextFormat type="date" value={table18.dateFinResv126} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.truncDateDebutResv127 ? (
                      <TextFormat type="date" value={table18.truncDateDebutResv127} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.truncDateFinResv128 ? (
                      <TextFormat type="date" value={table18.truncDateFinResv128} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateAnnResv129 ? (
                      <TextFormat type="date" value={table18.dateAnnResv129} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.pseudoRoomYn130}</td>
                  <td>{table18.createurResv131}</td>
                  <td>{table18.nomCreateurResv132}</td>
                  <td>{table18.codeGarantie133}</td>
                  <td>{table18.flgDed134}</td>
                  <td>{table18.codePays135}</td>
                  <td>{table18.libPays136}</td>
                  <td>{table18.codeNationalite137}</td>
                  <td>{table18.libNationalite138}</td>
                  <td>{table18.codeSource139}</td>
                  <td>{table18.libSource140}</td>
                  <td>{table18.codeGrandSource141}</td>
                  <td>{table18.codeOrigine142}</td>
                  <td>{table18.libOrigine143}</td>
                  <td>{table18.codeMarche144}</td>
                  <td>{table18.libMarche145}</td>
                  <td>{table18.codeGrandMarche146}</td>
                  <td>{table18.libGrandMarche147}</td>
                  <td>{table18.codePrix148}</td>
                  <td>{table18.categPrix149}</td>
                  <td>{table18.libPrix150}</td>
                  <td>{table18.numChb151}</td>
                  <td>{table18.descriptionTypeChb152}</td>
                  <td>{table18.codeTypeChb153}</td>
                  <td>{table18.classChb154}</td>
                  <td>{table18.caractChb155}</td>
                  <td>{table18.typeChbDeReservation156}</td>
                  <td>{table18.descriptionTypeChbDeResv157}</td>
                  <td>{table18.codeTypeChbDeResv158}</td>
                  <td>{table18.statutDeReservation159}</td>
                  <td>{table18.circuitDistribution160}</td>
                  <td>{table18.circuitDistribUserRegroup161}</td>
                  <td>{table18.numCrs162}</td>
                  <td>{table18.typeRefCrs163}</td>
                  <td>
                    {table18.crsInsertDate164 ? (
                      <TextFormat type="date" value={table18.crsInsertDate164} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateCreaResv165 ? (
                      <TextFormat type="date" value={table18.dateCreaResv165} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.datePremier166 ? (
                      <TextFormat type="date" value={table18.datePremier166} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.statutPremier167}</td>
                  <td>
                    {table18.dateDernier168 ? (
                      <TextFormat type="date" value={table18.dateDernier168} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.statutDernier169}</td>
                  <td>
                    {table18.dateDernierPseudo170 ? (
                      <TextFormat type="date" value={table18.dateDernierPseudo170} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.statutDernierPseudo171}</td>
                  <td>{table18.diffDtCreaAnn172}</td>
                  <td>{table18.diffDtArrAnn173}</td>
                  <td>{table18.leadtime174}</td>
                  <td>{table18.los175}</td>
                  <td>{table18.occupantsGroupe176}</td>
                  <td>{table18.nbNuitee177}</td>
                  <td>{table18.nbNuiteeNnDed178}</td>
                  <td>{table18.nbResvAnn179}</td>
                  <td>{table18.nbAdu180}</td>
                  <td>{table18.nbEnf181}</td>
                  <td>{table18.nbPersDayU182}</td>
                  <td>{table18.nbPersArr183}</td>
                  <td>{table18.nbPersDep184}</td>
                  <td>{table18.nbPersAnn185}</td>
                  <td>{table18.nbPersNoshow186}</td>
                  <td>{table18.nbChbDayU187}</td>
                  <td>{table18.nbChbArr188}</td>
                  <td>{table18.nbChbDep189}</td>
                  <td>{table18.nbChbAnn190}</td>
                  <td>{table18.nbChbNoshow191}</td>
                  <td>{table18.revenuNetChambre192}</td>
                  <td>{table18.revenuTaxeChambre193}</td>
                  <td>{table18.revenuNetChambreGlobal194}</td>
                  <td>{table18.revenuTaxeChambreGlobal195}</td>
                  <td>{table18.revenuNetBq196}</td>
                  <td>{table18.revenuTaxeBq197}</td>
                  <td>{table18.revenuNetBqGlobal198}</td>
                  <td>{table18.revenuTaxeBqGlobal199}</td>
                  <td>{table18.revenuNetExtra200}</td>
                  <td>{table18.revenuTaxeExtra201}</td>
                  <td>{table18.revenuNetExtraGlobal202}</td>
                  <td>{table18.revenuTaxeExtraGlobal203}</td>
                  <td>{table18.revenuNetTotal204}</td>
                  <td>{table18.revenuTaxeTotal205}</td>
                  <td>{table18.revenuNetTotalGlobal206}</td>
                  <td>{table18.revenuTaxeTotalGlobal207}</td>
                  <td>{table18.prodRevenuChambre208}</td>
                  <td>{table18.prodRevenuBq209}</td>
                  <td>{table18.prodRevenuExtra210}</td>
                  <td>{table18.prodRevenuTotal211}</td>
                  <td>{table18.prodChambreNbNuitees212}</td>
                  <td>
                    {table18.techCreateDate213 ? (
                      <TextFormat type="date" value={table18.techCreateDate213} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.techUpdateDate214 ? (
                      <TextFormat type="date" value={table18.techUpdateDate214} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.numLigne215}</td>
                  <td>{table18.resort216}</td>
                  <td>{table18.resvNameId217}</td>
                  <td>{table18.clientOId218}</td>
                  <td>{table18.typeChb219}</td>
                  <td>{table18.confirmationNo220}</td>
                  <td>{table18.clientMdmId221}</td>
                  <td>{table18.nameId222}</td>
                  <td>{table18.parentResvNameId223}</td>
                  <td>{table18.contactId224}</td>
                  <td>{table18.agenceId225}</td>
                  <td>{table18.agenceNom226}</td>
                  <td>{table18.societeId227}</td>
                  <td>{table18.groupeId228}</td>
                  <td>{table18.numBloc229}</td>
                  <td>{table18.typeResv230}</td>
                  <td>{table18.statutResv231}</td>
                  <td>
                    {table18.dateDebutResv232 ? (
                      <TextFormat type="date" value={table18.dateDebutResv232} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateFinResv233 ? (
                      <TextFormat type="date" value={table18.dateFinResv233} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.truncDateDebutResv234 ? (
                      <TextFormat type="date" value={table18.truncDateDebutResv234} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.truncDateFinResv235 ? (
                      <TextFormat type="date" value={table18.truncDateFinResv235} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateAnnResv236 ? (
                      <TextFormat type="date" value={table18.dateAnnResv236} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.pseudoRoomYn237}</td>
                  <td>{table18.createurResv238}</td>
                  <td>{table18.nomCreateurResv239}</td>
                  <td>{table18.codeGarantie240}</td>
                  <td>{table18.flgDed241}</td>
                  <td>{table18.codePays242}</td>
                  <td>{table18.libPays243}</td>
                  <td>{table18.codeNationalite244}</td>
                  <td>{table18.libNationalite245}</td>
                  <td>{table18.codeSource246}</td>
                  <td>{table18.libSource247}</td>
                  <td>{table18.codeGrandSource248}</td>
                  <td>{table18.codeOrigine249}</td>
                  <td>{table18.libOrigine250}</td>
                  <td>{table18.codeMarche251}</td>
                  <td>{table18.libMarche252}</td>
                  <td>{table18.codeGrandMarche253}</td>
                  <td>{table18.libGrandMarche254}</td>
                  <td>{table18.codePrix255}</td>
                  <td>{table18.categPrix256}</td>
                  <td>{table18.libPrix257}</td>
                  <td>{table18.numChb258}</td>
                  <td>{table18.descriptionTypeChb259}</td>
                  <td>{table18.codeTypeChb260}</td>
                  <td>{table18.classChb261}</td>
                  <td>{table18.caractChb262}</td>
                  <td>{table18.typeChbDeReservation263}</td>
                  <td>{table18.descriptionTypeChbDeResv264}</td>
                  <td>{table18.codeTypeChbDeResv265}</td>
                  <td>{table18.statutDeReservation266}</td>
                  <td>{table18.circuitDistribution267}</td>
                  <td>{table18.circuitDistribUserRegroup268}</td>
                  <td>{table18.numCrs269}</td>
                  <td>{table18.typeRefCrs270}</td>
                  <td>
                    {table18.crsInsertDate271 ? (
                      <TextFormat type="date" value={table18.crsInsertDate271} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.dateCreaResv272 ? (
                      <TextFormat type="date" value={table18.dateCreaResv272} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table18.datePremier273 ? (
                      <TextFormat type="date" value={table18.datePremier273} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.statutPremier274}</td>
                  <td>
                    {table18.dateDernier275 ? (
                      <TextFormat type="date" value={table18.dateDernier275} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.statutDernier276}</td>
                  <td>
                    {table18.dateDernierPseudo277 ? (
                      <TextFormat type="date" value={table18.dateDernierPseudo277} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table18.statutDernierPseudo278}</td>
                  <td>{table18.diffDtCreaAnn279}</td>
                  <td>{table18.diffDtArrAnn280}</td>
                  <td>{table18.leadtime281}</td>
                  <td>{table18.los282}</td>
                  <td>{table18.occupantsGroupe283}</td>
                  <td>{table18.nbNuitee284}</td>
                  <td>{table18.nbNuiteeNnDed285}</td>
                  <td>{table18.nbResvAnn286}</td>
                  <td>{table18.nbAdu287}</td>
                  <td>{table18.nbEnf288}</td>
                  <td>{table18.nbPersDayU289}</td>
                  <td>{table18.nbPersArr290}</td>
                  <td>{table18.nbPersDep291}</td>
                  <td>{table18.nbPersAnn292}</td>
                  <td>{table18.nbPersNoshow293}</td>
                  <td>{table18.nbChbDayU294}</td>
                  <td>{table18.nbChbArr295}</td>
                  <td>{table18.nbChbDep296}</td>
                  <td>{table18.nbChbAnn297}</td>
                  <td>{table18.nbChbNoshow298}</td>
                  <td>{table18.revenuNetChambre299}</td>
                  <td>{table18.revenuTaxeChambre300}</td>
                  <td>{table18.revenuNetChambreGlobal301}</td>
                  <td>{table18.revenuTaxeChambreGlobal302}</td>
                  <td>{table18.revenuNetBq303}</td>
                  <td>{table18.revenuTaxeBq304}</td>
                  <td>{table18.revenuNetBqGlobal305}</td>
                  <td>{table18.revenuTaxeBqGlobal306}</td>
                  <td>{table18.revenuNetExtra307}</td>
                  <td>{table18.revenuTaxeExtra308}</td>
                  <td>{table18.revenuNetExtraGlobal309}</td>
                  <td>{table18.revenuTaxeExtraGlobal310}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/table-18/${table18.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/table-18/${table18.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/table-18/${table18.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table18.home.notFound">No Table 18 S found</Translate>
            </div>
          )
        )}
      </div>
