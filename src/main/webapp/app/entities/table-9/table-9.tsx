  ...
  return (
    <div>
      <h2 id="table-9-heading" data-cy="Table9Heading">
        <Translate contentKey="big20SampleApplicationApp.table9.home.title">Table 9 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table9.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-9/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table9.home.createLabel">Create new Table 9</Translate>
          </Link>
        </div>
      </h2>
        ...
        {table9List && table9List.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table9.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table9.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table9.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal195')}>
                  <Translate contentKey="big20SampleApplicationApp.table9.revenuTaxeChambreGlobal195">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table9.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal302')}>
                  <Translate contentKey="big20SampleApplicationApp.table9.revenuTaxeChambreGlobal302">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table9.home.notFound">No Table 9 S found</Translate>
            </div>
          )
        )}
      </div>
