...
export const Table5DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="big20SampleApplicationApp.table5.delete.question">
        <Translate contentKey="big20SampleApplicationApp.table5.delete.question" interpolate={{ id: table5Entity.id }}>
