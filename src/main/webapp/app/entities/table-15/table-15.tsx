...
import { getEntities } from './table-15.reducer';
...
export const Table15 = () => {
  ...
  const table15List = useAppSelector(state => state.table15.entities);
  ...
  return (
    <div>
      <h2 id="table-15-heading" data-cy="Table15Heading">
        <Translate contentKey="big20SampleApplicationApp.table15.home.title">Table 15 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table15.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-15/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table15.home.createLabel">Create new Table 15</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {table15List && table15List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table15.revenuTaxeExtraGlobal310">
            ...
            <tbody>
              {table15List.map((table15, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/table-15/${table15.id}`} color="link" size="sm">
                      {table15.id}
                    </Button>
                  </td>
                  <td>{table15.numLigne1}</td>
                  <td>{table15.resort2}</td>
                  <td>{table15.resvNameId3}</td>
                  <td>{table15.clientOId4}</td>
                  <td>{table15.typeChb5}</td>
                  <td>{table15.confirmationNo6}</td>
                  <td>{table15.clientMdmId7}</td>
                  <td>{table15.nameId8}</td>
                  <td>{table15.parentResvNameId9}</td>
                  <td>{table15.contactId10}</td>
                  <td>{table15.agenceId11}</td>
                  <td>{table15.agenceNom12}</td>
                  <td>{table15.societeId13}</td>
                  <td>{table15.groupeId14}</td>
                  <td>{table15.numBloc15}</td>
                  <td>{table15.typeResv16}</td>
                  <td>{table15.statutResv17}</td>
                  <td>
                    {table15.dateDebutResv18 ? (
                      <TextFormat type="date" value={table15.dateDebutResv18} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateFinResv19 ? <TextFormat type="date" value={table15.dateFinResv19} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {table15.truncDateDebutResv20 ? (
                      <TextFormat type="date" value={table15.truncDateDebutResv20} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.truncDateFinResv21 ? (
                      <TextFormat type="date" value={table15.truncDateFinResv21} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateAnnResv22 ? <TextFormat type="date" value={table15.dateAnnResv22} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table15.pseudoRoomYn23}</td>
                  <td>{table15.createurResv24}</td>
                  <td>{table15.nomCreateurResv25}</td>
                  <td>{table15.codeGarantie26}</td>
                  <td>{table15.flgDed27}</td>
                  <td>{table15.codePays28}</td>
                  <td>{table15.libPays29}</td>
                  <td>{table15.codeNationalite30}</td>
                  <td>{table15.libNationalite31}</td>
                  <td>{table15.codeSource32}</td>
                  <td>{table15.libSource33}</td>
                  <td>{table15.codeGrandSource34}</td>
                  <td>{table15.codeOrigine35}</td>
                  <td>{table15.libOrigine36}</td>
                  <td>{table15.codeMarche37}</td>
                  <td>{table15.libMarche38}</td>
                  <td>{table15.codeGrandMarche39}</td>
                  <td>{table15.libGrandMarche40}</td>
                  <td>{table15.codePrix41}</td>
                  <td>{table15.categPrix42}</td>
                  <td>{table15.libPrix43}</td>
                  <td>{table15.numChb44}</td>
                  <td>{table15.descriptionTypeChb45}</td>
                  <td>{table15.codeTypeChb46}</td>
                  <td>{table15.classChb47}</td>
                  <td>{table15.caractChb48}</td>
                  <td>{table15.typeChbDeReservation49}</td>
                  <td>{table15.descriptionTypeChbDeResv50}</td>
                  <td>{table15.codeTypeChbDeResv51}</td>
                  <td>{table15.statutDeReservation52}</td>
                  <td>{table15.circuitDistribution53}</td>
                  <td>{table15.circuitDistribUserRegroup54}</td>
                  <td>{table15.numCrs55}</td>
                  <td>{table15.typeRefCrs56}</td>
                  <td>
                    {table15.crsInsertDate57 ? (
                      <TextFormat type="date" value={table15.crsInsertDate57} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateCreaResv58 ? (
                      <TextFormat type="date" value={table15.dateCreaResv58} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.datePremier59 ? <TextFormat type="date" value={table15.datePremier59} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table15.statutPremier60}</td>
                  <td>
                    {table15.dateDernier61 ? <TextFormat type="date" value={table15.dateDernier61} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table15.statutDernier62}</td>
                  <td>
                    {table15.dateDernierPseudo63 ? (
                      <TextFormat type="date" value={table15.dateDernierPseudo63} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.statutDernierPseudo64}</td>
                  <td>{table15.diffDtCreaAnn65}</td>
                  <td>{table15.diffDtArrAnn66}</td>
                  <td>{table15.leadtime67}</td>
                  <td>{table15.los68}</td>
                  <td>{table15.occupantsGroupe69}</td>
                  <td>{table15.nbNuitee70}</td>
                  <td>{table15.nbNuiteeNnDed71}</td>
                  <td>{table15.nbResvAnn72}</td>
                  <td>{table15.nbAdu73}</td>
                  <td>{table15.nbEnf74}</td>
                  <td>{table15.nbPersDayU75}</td>
                  <td>{table15.nbPersArr76}</td>
                  <td>{table15.nbPersDep77}</td>
                  <td>{table15.nbPersAnn78}</td>
                  <td>{table15.nbPersNoshow79}</td>
                  <td>{table15.nbChbDayU80}</td>
                  <td>{table15.nbChbArr81}</td>
                  <td>{table15.nbChbDep82}</td>
                  <td>{table15.nbChbAnn83}</td>
                  <td>{table15.nbChbNoshow84}</td>
                  <td>{table15.revenuNetChambre85}</td>
                  <td>{table15.revenuTaxeChambre86}</td>
                  <td>{table15.revenuNetChambreGlobal87}</td>
                  <td>{table15.revenuTaxeChambreGlobal88}</td>
                  <td>{table15.revenuNetBq89}</td>
                  <td>{table15.revenuTaxeBq90}</td>
                  <td>{table15.revenuNetBqGlobal91}</td>
                  <td>{table15.revenuTaxeBqGlobal92}</td>
                  <td>{table15.revenuNetExtra93}</td>
                  <td>{table15.revenuTaxeExtra94}</td>
                  <td>{table15.revenuNetExtraGlobal95}</td>
                  <td>{table15.revenuTaxeExtraGlobal96}</td>
                  <td>{table15.revenuNetTotal97}</td>
                  <td>{table15.revenuTaxeTotal98}</td>
                  <td>{table15.revenuNetTotalGlobal99}</td>
                  <td>{table15.revenuTaxeTotalGlobal100}</td>
                  <td>{table15.prodRevenuChambre101}</td>
                  <td>{table15.prodRevenuBq102}</td>
                  <td>{table15.prodRevenuExtra103}</td>
                  <td>{table15.prodRevenuTotal104}</td>
                  <td>{table15.prodChambreNbNuitees105}</td>
                  <td>
                    {table15.techCreateDate106 ? (
                      <TextFormat type="date" value={table15.techCreateDate106} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.techUpdateDate107 ? (
                      <TextFormat type="date" value={table15.techUpdateDate107} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.numLigne108}</td>
                  <td>{table15.resort109}</td>
                  <td>{table15.resvNameId110}</td>
                  <td>{table15.clientOId111}</td>
                  <td>{table15.typeChb112}</td>
                  <td>{table15.confirmationNo113}</td>
                  <td>{table15.clientMdmId114}</td>
                  <td>{table15.nameId115}</td>
                  <td>{table15.parentResvNameId116}</td>
                  <td>{table15.contactId117}</td>
                  <td>{table15.agenceId118}</td>
                  <td>{table15.agenceNom119}</td>
                  <td>{table15.societeId120}</td>
                  <td>{table15.groupeId121}</td>
                  <td>{table15.numBloc122}</td>
                  <td>{table15.typeResv123}</td>
                  <td>{table15.statutResv124}</td>
                  <td>
                    {table15.dateDebutResv125 ? (
                      <TextFormat type="date" value={table15.dateDebutResv125} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateFinResv126 ? (
                      <TextFormat type="date" value={table15.dateFinResv126} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.truncDateDebutResv127 ? (
                      <TextFormat type="date" value={table15.truncDateDebutResv127} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.truncDateFinResv128 ? (
                      <TextFormat type="date" value={table15.truncDateFinResv128} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateAnnResv129 ? (
                      <TextFormat type="date" value={table15.dateAnnResv129} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.pseudoRoomYn130}</td>
                  <td>{table15.createurResv131}</td>
                  <td>{table15.nomCreateurResv132}</td>
                  <td>{table15.codeGarantie133}</td>
                  <td>{table15.flgDed134}</td>
                  <td>{table15.codePays135}</td>
                  <td>{table15.libPays136}</td>
                  <td>{table15.codeNationalite137}</td>
                  <td>{table15.libNationalite138}</td>
                  <td>{table15.codeSource139}</td>
                  <td>{table15.libSource140}</td>
                  <td>{table15.codeGrandSource141}</td>
                  <td>{table15.codeOrigine142}</td>
                  <td>{table15.libOrigine143}</td>
                  <td>{table15.codeMarche144}</td>
                  <td>{table15.libMarche145}</td>
                  <td>{table15.codeGrandMarche146}</td>
                  <td>{table15.libGrandMarche147}</td>
                  <td>{table15.codePrix148}</td>
                  <td>{table15.categPrix149}</td>
                  <td>{table15.libPrix150}</td>
                  <td>{table15.numChb151}</td>
                  <td>{table15.descriptionTypeChb152}</td>
                  <td>{table15.codeTypeChb153}</td>
                  <td>{table15.classChb154}</td>
                  <td>{table15.caractChb155}</td>
                  <td>{table15.typeChbDeReservation156}</td>
                  <td>{table15.descriptionTypeChbDeResv157}</td>
                  <td>{table15.codeTypeChbDeResv158}</td>
                  <td>{table15.statutDeReservation159}</td>
                  <td>{table15.circuitDistribution160}</td>
                  <td>{table15.circuitDistribUserRegroup161}</td>
                  <td>{table15.numCrs162}</td>
                  <td>{table15.typeRefCrs163}</td>
                  <td>
                    {table15.crsInsertDate164 ? (
                      <TextFormat type="date" value={table15.crsInsertDate164} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateCreaResv165 ? (
                      <TextFormat type="date" value={table15.dateCreaResv165} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.datePremier166 ? (
                      <TextFormat type="date" value={table15.datePremier166} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.statutPremier167}</td>
                  <td>
                    {table15.dateDernier168 ? (
                      <TextFormat type="date" value={table15.dateDernier168} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.statutDernier169}</td>
                  <td>
                    {table15.dateDernierPseudo170 ? (
                      <TextFormat type="date" value={table15.dateDernierPseudo170} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.statutDernierPseudo171}</td>
                  <td>{table15.diffDtCreaAnn172}</td>
                  <td>{table15.diffDtArrAnn173}</td>
                  <td>{table15.leadtime174}</td>
                  <td>{table15.los175}</td>
                  <td>{table15.occupantsGroupe176}</td>
                  <td>{table15.nbNuitee177}</td>
                  <td>{table15.nbNuiteeNnDed178}</td>
                  <td>{table15.nbResvAnn179}</td>
                  <td>{table15.nbAdu180}</td>
                  <td>{table15.nbEnf181}</td>
                  <td>{table15.nbPersDayU182}</td>
                  <td>{table15.nbPersArr183}</td>
                  <td>{table15.nbPersDep184}</td>
                  <td>{table15.nbPersAnn185}</td>
                  <td>{table15.nbPersNoshow186}</td>
                  <td>{table15.nbChbDayU187}</td>
                  <td>{table15.nbChbArr188}</td>
                  <td>{table15.nbChbDep189}</td>
                  <td>{table15.nbChbAnn190}</td>
                  <td>{table15.nbChbNoshow191}</td>
                  <td>{table15.revenuNetChambre192}</td>
                  <td>{table15.revenuTaxeChambre193}</td>
                  <td>{table15.revenuNetChambreGlobal194}</td>
                  <td>{table15.revenuTaxeChambreGlobal195}</td>
                  <td>{table15.revenuNetBq196}</td>
                  <td>{table15.revenuTaxeBq197}</td>
                  <td>{table15.revenuNetBqGlobal198}</td>
                  <td>{table15.revenuTaxeBqGlobal199}</td>
                  <td>{table15.revenuNetExtra200}</td>
                  <td>{table15.revenuTaxeExtra201}</td>
                  <td>{table15.revenuNetExtraGlobal202}</td>
                  <td>{table15.revenuTaxeExtraGlobal203}</td>
                  <td>{table15.revenuNetTotal204}</td>
                  <td>{table15.revenuTaxeTotal205}</td>
                  <td>{table15.revenuNetTotalGlobal206}</td>
                  <td>{table15.revenuTaxeTotalGlobal207}</td>
                  <td>{table15.prodRevenuChambre208}</td>
                  <td>{table15.prodRevenuBq209}</td>
                  <td>{table15.prodRevenuExtra210}</td>
                  <td>{table15.prodRevenuTotal211}</td>
                  <td>{table15.prodChambreNbNuitees212}</td>
                  <td>
                    {table15.techCreateDate213 ? (
                      <TextFormat type="date" value={table15.techCreateDate213} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.techUpdateDate214 ? (
                      <TextFormat type="date" value={table15.techUpdateDate214} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.numLigne215}</td>
                  <td>{table15.resort216}</td>
                  <td>{table15.resvNameId217}</td>
                  <td>{table15.clientOId218}</td>
                  <td>{table15.typeChb219}</td>
                  <td>{table15.confirmationNo220}</td>
                  <td>{table15.clientMdmId221}</td>
                  <td>{table15.nameId222}</td>
                  <td>{table15.parentResvNameId223}</td>
                  <td>{table15.contactId224}</td>
                  <td>{table15.agenceId225}</td>
                  <td>{table15.agenceNom226}</td>
                  <td>{table15.societeId227}</td>
                  <td>{table15.groupeId228}</td>
                  <td>{table15.numBloc229}</td>
                  <td>{table15.typeResv230}</td>
                  <td>{table15.statutResv231}</td>
                  <td>
                    {table15.dateDebutResv232 ? (
                      <TextFormat type="date" value={table15.dateDebutResv232} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateFinResv233 ? (
                      <TextFormat type="date" value={table15.dateFinResv233} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.truncDateDebutResv234 ? (
                      <TextFormat type="date" value={table15.truncDateDebutResv234} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.truncDateFinResv235 ? (
                      <TextFormat type="date" value={table15.truncDateFinResv235} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateAnnResv236 ? (
                      <TextFormat type="date" value={table15.dateAnnResv236} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.pseudoRoomYn237}</td>
                  <td>{table15.createurResv238}</td>
                  <td>{table15.nomCreateurResv239}</td>
                  <td>{table15.codeGarantie240}</td>
                  <td>{table15.flgDed241}</td>
                  <td>{table15.codePays242}</td>
                  <td>{table15.libPays243}</td>
                  <td>{table15.codeNationalite244}</td>
                  <td>{table15.libNationalite245}</td>
                  <td>{table15.codeSource246}</td>
                  <td>{table15.libSource247}</td>
                  <td>{table15.codeGrandSource248}</td>
                  <td>{table15.codeOrigine249}</td>
                  <td>{table15.libOrigine250}</td>
                  <td>{table15.codeMarche251}</td>
                  <td>{table15.libMarche252}</td>
                  <td>{table15.codeGrandMarche253}</td>
                  <td>{table15.libGrandMarche254}</td>
                  <td>{table15.codePrix255}</td>
                  <td>{table15.categPrix256}</td>
                  <td>{table15.libPrix257}</td>
                  <td>{table15.numChb258}</td>
                  <td>{table15.descriptionTypeChb259}</td>
                  <td>{table15.codeTypeChb260}</td>
                  <td>{table15.classChb261}</td>
                  <td>{table15.caractChb262}</td>
                  <td>{table15.typeChbDeReservation263}</td>
                  <td>{table15.descriptionTypeChbDeResv264}</td>
                  <td>{table15.codeTypeChbDeResv265}</td>
                  <td>{table15.statutDeReservation266}</td>
                  <td>{table15.circuitDistribution267}</td>
                  <td>{table15.circuitDistribUserRegroup268}</td>
                  <td>{table15.numCrs269}</td>
                  <td>{table15.typeRefCrs270}</td>
                  <td>
                    {table15.crsInsertDate271 ? (
                      <TextFormat type="date" value={table15.crsInsertDate271} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.dateCreaResv272 ? (
                      <TextFormat type="date" value={table15.dateCreaResv272} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table15.datePremier273 ? (
                      <TextFormat type="date" value={table15.datePremier273} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.statutPremier274}</td>
                  <td>
                    {table15.dateDernier275 ? (
                      <TextFormat type="date" value={table15.dateDernier275} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.statutDernier276}</td>
                  <td>
                    {table15.dateDernierPseudo277 ? (
                      <TextFormat type="date" value={table15.dateDernierPseudo277} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table15.statutDernierPseudo278}</td>
                  <td>{table15.diffDtCreaAnn279}</td>
                  <td>{table15.diffDtArrAnn280}</td>
                  <td>{table15.leadtime281}</td>
                  <td>{table15.los282}</td>
                  <td>{table15.occupantsGroupe283}</td>
                  <td>{table15.nbNuitee284}</td>
                  <td>{table15.nbNuiteeNnDed285}</td>
                  <td>{table15.nbResvAnn286}</td>
                  <td>{table15.nbAdu287}</td>
                  <td>{table15.nbEnf288}</td>
                  <td>{table15.nbPersDayU289}</td>
                  <td>{table15.nbPersArr290}</td>
                  <td>{table15.nbPersDep291}</td>
                  <td>{table15.nbPersAnn292}</td>
                  <td>{table15.nbPersNoshow293}</td>
                  <td>{table15.nbChbDayU294}</td>
                  <td>{table15.nbChbArr295}</td>
                  <td>{table15.nbChbDep296}</td>
                  <td>{table15.nbChbAnn297}</td>
                  <td>{table15.nbChbNoshow298}</td>
                  <td>{table15.revenuNetChambre299}</td>
                  <td>{table15.revenuTaxeChambre300}</td>
                  <td>{table15.revenuNetChambreGlobal301}</td>
                  <td>{table15.revenuTaxeChambreGlobal302}</td>
                  <td>{table15.revenuNetBq303}</td>
                  <td>{table15.revenuTaxeBq304}</td>
                  <td>{table15.revenuNetBqGlobal305}</td>
                  <td>{table15.revenuTaxeBqGlobal306}</td>
                  <td>{table15.revenuNetExtra307}</td>
                  <td>{table15.revenuTaxeExtra308}</td>
                  <td>{table15.revenuNetExtraGlobal309}</td>
                  <td>{table15.revenuTaxeExtraGlobal310}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/table-15/${table15.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/table-15/${table15.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/table-15/${table15.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table15.home.notFound">No Table 15 S found</Translate>
            </div>
          )
        )}
      </div>
