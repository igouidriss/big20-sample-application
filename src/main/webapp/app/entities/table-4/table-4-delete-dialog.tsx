...
export const Table4DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="big20SampleApplicationApp.table4.delete.question">
        <Translate contentKey="big20SampleApplicationApp.table4.delete.question" interpolate={{ id: table4Entity.id }}>
