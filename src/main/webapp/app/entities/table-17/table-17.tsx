...
import { getEntities } from './table-17.reducer';
...
export const Table17 = () => {
  ...
  const table17List = useAppSelector(state => state.table17.entities);
  ...
  return (
    <div>
      <h2 id="table-17-heading" data-cy="Table17Heading">
        <Translate contentKey="big20SampleApplicationApp.table17.home.title">Table 17 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table17.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-17/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table17.home.createLabel">Create new Table 17</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {table17List && table17List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table17.revenuTaxeExtraGlobal310">
            ...
            <tbody>
              {table17List.map((table17, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/table-17/${table17.id}`} color="link" size="sm">
                      {table17.id}
                    </Button>
                  </td>
                  <td>{table17.numLigne1}</td>
                  <td>{table17.resort2}</td>
                  <td>{table17.resvNameId3}</td>
                  <td>{table17.clientOId4}</td>
                  <td>{table17.typeChb5}</td>
                  <td>{table17.confirmationNo6}</td>
                  <td>{table17.clientMdmId7}</td>
                  <td>{table17.nameId8}</td>
                  <td>{table17.parentResvNameId9}</td>
                  <td>{table17.contactId10}</td>
                  <td>{table17.agenceId11}</td>
                  <td>{table17.agenceNom12}</td>
                  <td>{table17.societeId13}</td>
                  <td>{table17.groupeId14}</td>
                  <td>{table17.numBloc15}</td>
                  <td>{table17.typeResv16}</td>
                  <td>{table17.statutResv17}</td>
                  <td>
                    {table17.dateDebutResv18 ? (
                      <TextFormat type="date" value={table17.dateDebutResv18} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateFinResv19 ? <TextFormat type="date" value={table17.dateFinResv19} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {table17.truncDateDebutResv20 ? (
                      <TextFormat type="date" value={table17.truncDateDebutResv20} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.truncDateFinResv21 ? (
                      <TextFormat type="date" value={table17.truncDateFinResv21} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateAnnResv22 ? <TextFormat type="date" value={table17.dateAnnResv22} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table17.pseudoRoomYn23}</td>
                  <td>{table17.createurResv24}</td>
                  <td>{table17.nomCreateurResv25}</td>
                  <td>{table17.codeGarantie26}</td>
                  <td>{table17.flgDed27}</td>
                  <td>{table17.codePays28}</td>
                  <td>{table17.libPays29}</td>
                  <td>{table17.codeNationalite30}</td>
                  <td>{table17.libNationalite31}</td>
                  <td>{table17.codeSource32}</td>
                  <td>{table17.libSource33}</td>
                  <td>{table17.codeGrandSource34}</td>
                  <td>{table17.codeOrigine35}</td>
                  <td>{table17.libOrigine36}</td>
                  <td>{table17.codeMarche37}</td>
                  <td>{table17.libMarche38}</td>
                  <td>{table17.codeGrandMarche39}</td>
                  <td>{table17.libGrandMarche40}</td>
                  <td>{table17.codePrix41}</td>
                  <td>{table17.categPrix42}</td>
                  <td>{table17.libPrix43}</td>
                  <td>{table17.numChb44}</td>
                  <td>{table17.descriptionTypeChb45}</td>
                  <td>{table17.codeTypeChb46}</td>
                  <td>{table17.classChb47}</td>
                  <td>{table17.caractChb48}</td>
                  <td>{table17.typeChbDeReservation49}</td>
                  <td>{table17.descriptionTypeChbDeResv50}</td>
                  <td>{table17.codeTypeChbDeResv51}</td>
                  <td>{table17.statutDeReservation52}</td>
                  <td>{table17.circuitDistribution53}</td>
                  <td>{table17.circuitDistribUserRegroup54}</td>
                  <td>{table17.numCrs55}</td>
                  <td>{table17.typeRefCrs56}</td>
                  <td>
                    {table17.crsInsertDate57 ? (
                      <TextFormat type="date" value={table17.crsInsertDate57} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateCreaResv58 ? (
                      <TextFormat type="date" value={table17.dateCreaResv58} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.datePremier59 ? <TextFormat type="date" value={table17.datePremier59} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table17.statutPremier60}</td>
                  <td>
                    {table17.dateDernier61 ? <TextFormat type="date" value={table17.dateDernier61} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table17.statutDernier62}</td>
                  <td>
                    {table17.dateDernierPseudo63 ? (
                      <TextFormat type="date" value={table17.dateDernierPseudo63} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.statutDernierPseudo64}</td>
                  <td>{table17.diffDtCreaAnn65}</td>
                  <td>{table17.diffDtArrAnn66}</td>
                  <td>{table17.leadtime67}</td>
                  <td>{table17.los68}</td>
                  <td>{table17.occupantsGroupe69}</td>
                  <td>{table17.nbNuitee70}</td>
                  <td>{table17.nbNuiteeNnDed71}</td>
                  <td>{table17.nbResvAnn72}</td>
                  <td>{table17.nbAdu73}</td>
                  <td>{table17.nbEnf74}</td>
                  <td>{table17.nbPersDayU75}</td>
                  <td>{table17.nbPersArr76}</td>
                  <td>{table17.nbPersDep77}</td>
                  <td>{table17.nbPersAnn78}</td>
                  <td>{table17.nbPersNoshow79}</td>
                  <td>{table17.nbChbDayU80}</td>
                  <td>{table17.nbChbArr81}</td>
                  <td>{table17.nbChbDep82}</td>
                  <td>{table17.nbChbAnn83}</td>
                  <td>{table17.nbChbNoshow84}</td>
                  <td>{table17.revenuNetChambre85}</td>
                  <td>{table17.revenuTaxeChambre86}</td>
                  <td>{table17.revenuNetChambreGlobal87}</td>
                  <td>{table17.revenuTaxeChambreGlobal88}</td>
                  <td>{table17.revenuNetBq89}</td>
                  <td>{table17.revenuTaxeBq90}</td>
                  <td>{table17.revenuNetBqGlobal91}</td>
                  <td>{table17.revenuTaxeBqGlobal92}</td>
                  <td>{table17.revenuNetExtra93}</td>
                  <td>{table17.revenuTaxeExtra94}</td>
                  <td>{table17.revenuNetExtraGlobal95}</td>
                  <td>{table17.revenuTaxeExtraGlobal96}</td>
                  <td>{table17.revenuNetTotal97}</td>
                  <td>{table17.revenuTaxeTotal98}</td>
                  <td>{table17.revenuNetTotalGlobal99}</td>
                  <td>{table17.revenuTaxeTotalGlobal100}</td>
                  <td>{table17.prodRevenuChambre101}</td>
                  <td>{table17.prodRevenuBq102}</td>
                  <td>{table17.prodRevenuExtra103}</td>
                  <td>{table17.prodRevenuTotal104}</td>
                  <td>{table17.prodChambreNbNuitees105}</td>
                  <td>
                    {table17.techCreateDate106 ? (
                      <TextFormat type="date" value={table17.techCreateDate106} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.techUpdateDate107 ? (
                      <TextFormat type="date" value={table17.techUpdateDate107} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.numLigne108}</td>
                  <td>{table17.resort109}</td>
                  <td>{table17.resvNameId110}</td>
                  <td>{table17.clientOId111}</td>
                  <td>{table17.typeChb112}</td>
                  <td>{table17.confirmationNo113}</td>
                  <td>{table17.clientMdmId114}</td>
                  <td>{table17.nameId115}</td>
                  <td>{table17.parentResvNameId116}</td>
                  <td>{table17.contactId117}</td>
                  <td>{table17.agenceId118}</td>
                  <td>{table17.agenceNom119}</td>
                  <td>{table17.societeId120}</td>
                  <td>{table17.groupeId121}</td>
                  <td>{table17.numBloc122}</td>
                  <td>{table17.typeResv123}</td>
                  <td>{table17.statutResv124}</td>
                  <td>
                    {table17.dateDebutResv125 ? (
                      <TextFormat type="date" value={table17.dateDebutResv125} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateFinResv126 ? (
                      <TextFormat type="date" value={table17.dateFinResv126} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.truncDateDebutResv127 ? (
                      <TextFormat type="date" value={table17.truncDateDebutResv127} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.truncDateFinResv128 ? (
                      <TextFormat type="date" value={table17.truncDateFinResv128} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateAnnResv129 ? (
                      <TextFormat type="date" value={table17.dateAnnResv129} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.pseudoRoomYn130}</td>
                  <td>{table17.createurResv131}</td>
                  <td>{table17.nomCreateurResv132}</td>
                  <td>{table17.codeGarantie133}</td>
                  <td>{table17.flgDed134}</td>
                  <td>{table17.codePays135}</td>
                  <td>{table17.libPays136}</td>
                  <td>{table17.codeNationalite137}</td>
                  <td>{table17.libNationalite138}</td>
                  <td>{table17.codeSource139}</td>
                  <td>{table17.libSource140}</td>
                  <td>{table17.codeGrandSource141}</td>
                  <td>{table17.codeOrigine142}</td>
                  <td>{table17.libOrigine143}</td>
                  <td>{table17.codeMarche144}</td>
                  <td>{table17.libMarche145}</td>
                  <td>{table17.codeGrandMarche146}</td>
                  <td>{table17.libGrandMarche147}</td>
                  <td>{table17.codePrix148}</td>
                  <td>{table17.categPrix149}</td>
                  <td>{table17.libPrix150}</td>
                  <td>{table17.numChb151}</td>
                  <td>{table17.descriptionTypeChb152}</td>
                  <td>{table17.codeTypeChb153}</td>
                  <td>{table17.classChb154}</td>
                  <td>{table17.caractChb155}</td>
                  <td>{table17.typeChbDeReservation156}</td>
                  <td>{table17.descriptionTypeChbDeResv157}</td>
                  <td>{table17.codeTypeChbDeResv158}</td>
                  <td>{table17.statutDeReservation159}</td>
                  <td>{table17.circuitDistribution160}</td>
                  <td>{table17.circuitDistribUserRegroup161}</td>
                  <td>{table17.numCrs162}</td>
                  <td>{table17.typeRefCrs163}</td>
                  <td>
                    {table17.crsInsertDate164 ? (
                      <TextFormat type="date" value={table17.crsInsertDate164} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateCreaResv165 ? (
                      <TextFormat type="date" value={table17.dateCreaResv165} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.datePremier166 ? (
                      <TextFormat type="date" value={table17.datePremier166} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.statutPremier167}</td>
                  <td>
                    {table17.dateDernier168 ? (
                      <TextFormat type="date" value={table17.dateDernier168} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.statutDernier169}</td>
                  <td>
                    {table17.dateDernierPseudo170 ? (
                      <TextFormat type="date" value={table17.dateDernierPseudo170} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.statutDernierPseudo171}</td>
                  <td>{table17.diffDtCreaAnn172}</td>
                  <td>{table17.diffDtArrAnn173}</td>
                  <td>{table17.leadtime174}</td>
                  <td>{table17.los175}</td>
                  <td>{table17.occupantsGroupe176}</td>
                  <td>{table17.nbNuitee177}</td>
                  <td>{table17.nbNuiteeNnDed178}</td>
                  <td>{table17.nbResvAnn179}</td>
                  <td>{table17.nbAdu180}</td>
                  <td>{table17.nbEnf181}</td>
                  <td>{table17.nbPersDayU182}</td>
                  <td>{table17.nbPersArr183}</td>
                  <td>{table17.nbPersDep184}</td>
                  <td>{table17.nbPersAnn185}</td>
                  <td>{table17.nbPersNoshow186}</td>
                  <td>{table17.nbChbDayU187}</td>
                  <td>{table17.nbChbArr188}</td>
                  <td>{table17.nbChbDep189}</td>
                  <td>{table17.nbChbAnn190}</td>
                  <td>{table17.nbChbNoshow191}</td>
                  <td>{table17.revenuNetChambre192}</td>
                  <td>{table17.revenuTaxeChambre193}</td>
                  <td>{table17.revenuNetChambreGlobal194}</td>
                  <td>{table17.revenuTaxeChambreGlobal195}</td>
                  <td>{table17.revenuNetBq196}</td>
                  <td>{table17.revenuTaxeBq197}</td>
                  <td>{table17.revenuNetBqGlobal198}</td>
                  <td>{table17.revenuTaxeBqGlobal199}</td>
                  <td>{table17.revenuNetExtra200}</td>
                  <td>{table17.revenuTaxeExtra201}</td>
                  <td>{table17.revenuNetExtraGlobal202}</td>
                  <td>{table17.revenuTaxeExtraGlobal203}</td>
                  <td>{table17.revenuNetTotal204}</td>
                  <td>{table17.revenuTaxeTotal205}</td>
                  <td>{table17.revenuNetTotalGlobal206}</td>
                  <td>{table17.revenuTaxeTotalGlobal207}</td>
                  <td>{table17.prodRevenuChambre208}</td>
                  <td>{table17.prodRevenuBq209}</td>
                  <td>{table17.prodRevenuExtra210}</td>
                  <td>{table17.prodRevenuTotal211}</td>
                  <td>{table17.prodChambreNbNuitees212}</td>
                  <td>
                    {table17.techCreateDate213 ? (
                      <TextFormat type="date" value={table17.techCreateDate213} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.techUpdateDate214 ? (
                      <TextFormat type="date" value={table17.techUpdateDate214} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.numLigne215}</td>
                  <td>{table17.resort216}</td>
                  <td>{table17.resvNameId217}</td>
                  <td>{table17.clientOId218}</td>
                  <td>{table17.typeChb219}</td>
                  <td>{table17.confirmationNo220}</td>
                  <td>{table17.clientMdmId221}</td>
                  <td>{table17.nameId222}</td>
                  <td>{table17.parentResvNameId223}</td>
                  <td>{table17.contactId224}</td>
                  <td>{table17.agenceId225}</td>
                  <td>{table17.agenceNom226}</td>
                  <td>{table17.societeId227}</td>
                  <td>{table17.groupeId228}</td>
                  <td>{table17.numBloc229}</td>
                  <td>{table17.typeResv230}</td>
                  <td>{table17.statutResv231}</td>
                  <td>
                    {table17.dateDebutResv232 ? (
                      <TextFormat type="date" value={table17.dateDebutResv232} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateFinResv233 ? (
                      <TextFormat type="date" value={table17.dateFinResv233} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.truncDateDebutResv234 ? (
                      <TextFormat type="date" value={table17.truncDateDebutResv234} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.truncDateFinResv235 ? (
                      <TextFormat type="date" value={table17.truncDateFinResv235} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateAnnResv236 ? (
                      <TextFormat type="date" value={table17.dateAnnResv236} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.pseudoRoomYn237}</td>
                  <td>{table17.createurResv238}</td>
                  <td>{table17.nomCreateurResv239}</td>
                  <td>{table17.codeGarantie240}</td>
                  <td>{table17.flgDed241}</td>
                  <td>{table17.codePays242}</td>
                  <td>{table17.libPays243}</td>
                  <td>{table17.codeNationalite244}</td>
                  <td>{table17.libNationalite245}</td>
                  <td>{table17.codeSource246}</td>
                  <td>{table17.libSource247}</td>
                  <td>{table17.codeGrandSource248}</td>
                  <td>{table17.codeOrigine249}</td>
                  <td>{table17.libOrigine250}</td>
                  <td>{table17.codeMarche251}</td>
                  <td>{table17.libMarche252}</td>
                  <td>{table17.codeGrandMarche253}</td>
                  <td>{table17.libGrandMarche254}</td>
                  <td>{table17.codePrix255}</td>
                  <td>{table17.categPrix256}</td>
                  <td>{table17.libPrix257}</td>
                  <td>{table17.numChb258}</td>
                  <td>{table17.descriptionTypeChb259}</td>
                  <td>{table17.codeTypeChb260}</td>
                  <td>{table17.classChb261}</td>
                  <td>{table17.caractChb262}</td>
                  <td>{table17.typeChbDeReservation263}</td>
                  <td>{table17.descriptionTypeChbDeResv264}</td>
                  <td>{table17.codeTypeChbDeResv265}</td>
                  <td>{table17.statutDeReservation266}</td>
                  <td>{table17.circuitDistribution267}</td>
                  <td>{table17.circuitDistribUserRegroup268}</td>
                  <td>{table17.numCrs269}</td>
                  <td>{table17.typeRefCrs270}</td>
                  <td>
                    {table17.crsInsertDate271 ? (
                      <TextFormat type="date" value={table17.crsInsertDate271} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.dateCreaResv272 ? (
                      <TextFormat type="date" value={table17.dateCreaResv272} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table17.datePremier273 ? (
                      <TextFormat type="date" value={table17.datePremier273} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.statutPremier274}</td>
                  <td>
                    {table17.dateDernier275 ? (
                      <TextFormat type="date" value={table17.dateDernier275} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.statutDernier276}</td>
                  <td>
                    {table17.dateDernierPseudo277 ? (
                      <TextFormat type="date" value={table17.dateDernierPseudo277} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table17.statutDernierPseudo278}</td>
                  <td>{table17.diffDtCreaAnn279}</td>
                  <td>{table17.diffDtArrAnn280}</td>
                  <td>{table17.leadtime281}</td>
                  <td>{table17.los282}</td>
                  <td>{table17.occupantsGroupe283}</td>
                  <td>{table17.nbNuitee284}</td>
                  <td>{table17.nbNuiteeNnDed285}</td>
                  <td>{table17.nbResvAnn286}</td>
                  <td>{table17.nbAdu287}</td>
                  <td>{table17.nbEnf288}</td>
                  <td>{table17.nbPersDayU289}</td>
                  <td>{table17.nbPersArr290}</td>
                  <td>{table17.nbPersDep291}</td>
                  <td>{table17.nbPersAnn292}</td>
                  <td>{table17.nbPersNoshow293}</td>
                  <td>{table17.nbChbDayU294}</td>
                  <td>{table17.nbChbArr295}</td>
                  <td>{table17.nbChbDep296}</td>
                  <td>{table17.nbChbAnn297}</td>
                  <td>{table17.nbChbNoshow298}</td>
                  <td>{table17.revenuNetChambre299}</td>
                  <td>{table17.revenuTaxeChambre300}</td>
                  <td>{table17.revenuNetChambreGlobal301}</td>
                  <td>{table17.revenuTaxeChambreGlobal302}</td>
                  <td>{table17.revenuNetBq303}</td>
                  <td>{table17.revenuTaxeBq304}</td>
                  <td>{table17.revenuNetBqGlobal305}</td>
                  <td>{table17.revenuTaxeBqGlobal306}</td>
                  <td>{table17.revenuNetExtra307}</td>
                  <td>{table17.revenuTaxeExtra308}</td>
                  <td>{table17.revenuNetExtraGlobal309}</td>
                  <td>{table17.revenuTaxeExtraGlobal310}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/table-17/${table17.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/table-17/${table17.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/table-17/${table17.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table17.home.notFound">No Table 17 S found</Translate>
            </div>
          )
        )}
      </div>
