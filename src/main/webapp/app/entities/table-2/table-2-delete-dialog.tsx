...
export const Table2DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="big20SampleApplicationApp.table2.delete.question">
        <Translate contentKey="big20SampleApplicationApp.table2.delete.question" interpolate={{ id: table2Entity.id }}>
