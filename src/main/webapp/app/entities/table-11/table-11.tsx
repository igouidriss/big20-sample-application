...
import { getEntities } from './table-11.reducer';
...
export const Table11 = () => {
  ...
  const table11List = useAppSelector(state => state.table11.entities);
  ...
  return (
    <div>
      <h2 id="table-11-heading" data-cy="Table11Heading">
        <Translate contentKey="big20SampleApplicationApp.table11.home.title">Table 11 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table11.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-11/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table11.home.createLabel">Create new Table 11</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {table11List && table11List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table11.revenuTaxeExtraGlobal310">
            ...
            <tbody>
              {table11List.map((table11, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/table-11/${table11.id}`} color="link" size="sm">
                      {table11.id}
                    </Button>
                  </td>
                  <td>{table11.numLigne1}</td>
                  <td>{table11.resort2}</td>
                  <td>{table11.resvNameId3}</td>
                  <td>{table11.clientOId4}</td>
                  <td>{table11.typeChb5}</td>
                  <td>{table11.confirmationNo6}</td>
                  <td>{table11.clientMdmId7}</td>
                  <td>{table11.nameId8}</td>
                  <td>{table11.parentResvNameId9}</td>
                  <td>{table11.contactId10}</td>
                  <td>{table11.agenceId11}</td>
                  <td>{table11.agenceNom12}</td>
                  <td>{table11.societeId13}</td>
                  <td>{table11.groupeId14}</td>
                  <td>{table11.numBloc15}</td>
                  <td>{table11.typeResv16}</td>
                  <td>{table11.statutResv17}</td>
                  <td>
                    {table11.dateDebutResv18 ? (
                      <TextFormat type="date" value={table11.dateDebutResv18} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateFinResv19 ? <TextFormat type="date" value={table11.dateFinResv19} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {table11.truncDateDebutResv20 ? (
                      <TextFormat type="date" value={table11.truncDateDebutResv20} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.truncDateFinResv21 ? (
                      <TextFormat type="date" value={table11.truncDateFinResv21} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateAnnResv22 ? <TextFormat type="date" value={table11.dateAnnResv22} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table11.pseudoRoomYn23}</td>
                  <td>{table11.createurResv24}</td>
                  <td>{table11.nomCreateurResv25}</td>
                  <td>{table11.codeGarantie26}</td>
                  <td>{table11.flgDed27}</td>
                  <td>{table11.codePays28}</td>
                  <td>{table11.libPays29}</td>
                  <td>{table11.codeNationalite30}</td>
                  <td>{table11.libNationalite31}</td>
                  <td>{table11.codeSource32}</td>
                  <td>{table11.libSource33}</td>
                  <td>{table11.codeGrandSource34}</td>
                  <td>{table11.codeOrigine35}</td>
                  <td>{table11.libOrigine36}</td>
                  <td>{table11.codeMarche37}</td>
                  <td>{table11.libMarche38}</td>
                  <td>{table11.codeGrandMarche39}</td>
                  <td>{table11.libGrandMarche40}</td>
                  <td>{table11.codePrix41}</td>
                  <td>{table11.categPrix42}</td>
                  <td>{table11.libPrix43}</td>
                  <td>{table11.numChb44}</td>
                  <td>{table11.descriptionTypeChb45}</td>
                  <td>{table11.codeTypeChb46}</td>
                  <td>{table11.classChb47}</td>
                  <td>{table11.caractChb48}</td>
                  <td>{table11.typeChbDeReservation49}</td>
                  <td>{table11.descriptionTypeChbDeResv50}</td>
                  <td>{table11.codeTypeChbDeResv51}</td>
                  <td>{table11.statutDeReservation52}</td>
                  <td>{table11.circuitDistribution53}</td>
                  <td>{table11.circuitDistribUserRegroup54}</td>
                  <td>{table11.numCrs55}</td>
                  <td>{table11.typeRefCrs56}</td>
                  <td>
                    {table11.crsInsertDate57 ? (
                      <TextFormat type="date" value={table11.crsInsertDate57} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateCreaResv58 ? (
                      <TextFormat type="date" value={table11.dateCreaResv58} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.datePremier59 ? <TextFormat type="date" value={table11.datePremier59} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table11.statutPremier60}</td>
                  <td>
                    {table11.dateDernier61 ? <TextFormat type="date" value={table11.dateDernier61} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table11.statutDernier62}</td>
                  <td>
                    {table11.dateDernierPseudo63 ? (
                      <TextFormat type="date" value={table11.dateDernierPseudo63} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.statutDernierPseudo64}</td>
                  <td>{table11.diffDtCreaAnn65}</td>
                  <td>{table11.diffDtArrAnn66}</td>
                  <td>{table11.leadtime67}</td>
                  <td>{table11.los68}</td>
                  <td>{table11.occupantsGroupe69}</td>
                  <td>{table11.nbNuitee70}</td>
                  <td>{table11.nbNuiteeNnDed71}</td>
                  <td>{table11.nbResvAnn72}</td>
                  <td>{table11.nbAdu73}</td>
                  <td>{table11.nbEnf74}</td>
                  <td>{table11.nbPersDayU75}</td>
                  <td>{table11.nbPersArr76}</td>
                  <td>{table11.nbPersDep77}</td>
                  <td>{table11.nbPersAnn78}</td>
                  <td>{table11.nbPersNoshow79}</td>
                  <td>{table11.nbChbDayU80}</td>
                  <td>{table11.nbChbArr81}</td>
                  <td>{table11.nbChbDep82}</td>
                  <td>{table11.nbChbAnn83}</td>
                  <td>{table11.nbChbNoshow84}</td>
                  <td>{table11.revenuNetChambre85}</td>
                  <td>{table11.revenuTaxeChambre86}</td>
                  <td>{table11.revenuNetChambreGlobal87}</td>
                  <td>{table11.revenuTaxeChambreGlobal88}</td>
                  <td>{table11.revenuNetBq89}</td>
                  <td>{table11.revenuTaxeBq90}</td>
                  <td>{table11.revenuNetBqGlobal91}</td>
                  <td>{table11.revenuTaxeBqGlobal92}</td>
                  <td>{table11.revenuNetExtra93}</td>
                  <td>{table11.revenuTaxeExtra94}</td>
                  <td>{table11.revenuNetExtraGlobal95}</td>
                  <td>{table11.revenuTaxeExtraGlobal96}</td>
                  <td>{table11.revenuNetTotal97}</td>
                  <td>{table11.revenuTaxeTotal98}</td>
                  <td>{table11.revenuNetTotalGlobal99}</td>
                  <td>{table11.revenuTaxeTotalGlobal100}</td>
                  <td>{table11.prodRevenuChambre101}</td>
                  <td>{table11.prodRevenuBq102}</td>
                  <td>{table11.prodRevenuExtra103}</td>
                  <td>{table11.prodRevenuTotal104}</td>
                  <td>{table11.prodChambreNbNuitees105}</td>
                  <td>
                    {table11.techCreateDate106 ? (
                      <TextFormat type="date" value={table11.techCreateDate106} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.techUpdateDate107 ? (
                      <TextFormat type="date" value={table11.techUpdateDate107} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.numLigne108}</td>
                  <td>{table11.resort109}</td>
                  <td>{table11.resvNameId110}</td>
                  <td>{table11.clientOId111}</td>
                  <td>{table11.typeChb112}</td>
                  <td>{table11.confirmationNo113}</td>
                  <td>{table11.clientMdmId114}</td>
                  <td>{table11.nameId115}</td>
                  <td>{table11.parentResvNameId116}</td>
                  <td>{table11.contactId117}</td>
                  <td>{table11.agenceId118}</td>
                  <td>{table11.agenceNom119}</td>
                  <td>{table11.societeId120}</td>
                  <td>{table11.groupeId121}</td>
                  <td>{table11.numBloc122}</td>
                  <td>{table11.typeResv123}</td>
                  <td>{table11.statutResv124}</td>
                  <td>
                    {table11.dateDebutResv125 ? (
                      <TextFormat type="date" value={table11.dateDebutResv125} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateFinResv126 ? (
                      <TextFormat type="date" value={table11.dateFinResv126} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.truncDateDebutResv127 ? (
                      <TextFormat type="date" value={table11.truncDateDebutResv127} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.truncDateFinResv128 ? (
                      <TextFormat type="date" value={table11.truncDateFinResv128} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateAnnResv129 ? (
                      <TextFormat type="date" value={table11.dateAnnResv129} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.pseudoRoomYn130}</td>
                  <td>{table11.createurResv131}</td>
                  <td>{table11.nomCreateurResv132}</td>
                  <td>{table11.codeGarantie133}</td>
                  <td>{table11.flgDed134}</td>
                  <td>{table11.codePays135}</td>
                  <td>{table11.libPays136}</td>
                  <td>{table11.codeNationalite137}</td>
                  <td>{table11.libNationalite138}</td>
                  <td>{table11.codeSource139}</td>
                  <td>{table11.libSource140}</td>
                  <td>{table11.codeGrandSource141}</td>
                  <td>{table11.codeOrigine142}</td>
                  <td>{table11.libOrigine143}</td>
                  <td>{table11.codeMarche144}</td>
                  <td>{table11.libMarche145}</td>
                  <td>{table11.codeGrandMarche146}</td>
                  <td>{table11.libGrandMarche147}</td>
                  <td>{table11.codePrix148}</td>
                  <td>{table11.categPrix149}</td>
                  <td>{table11.libPrix150}</td>
                  <td>{table11.numChb151}</td>
                  <td>{table11.descriptionTypeChb152}</td>
                  <td>{table11.codeTypeChb153}</td>
                  <td>{table11.classChb154}</td>
                  <td>{table11.caractChb155}</td>
                  <td>{table11.typeChbDeReservation156}</td>
                  <td>{table11.descriptionTypeChbDeResv157}</td>
                  <td>{table11.codeTypeChbDeResv158}</td>
                  <td>{table11.statutDeReservation159}</td>
                  <td>{table11.circuitDistribution160}</td>
                  <td>{table11.circuitDistribUserRegroup161}</td>
                  <td>{table11.numCrs162}</td>
                  <td>{table11.typeRefCrs163}</td>
                  <td>
                    {table11.crsInsertDate164 ? (
                      <TextFormat type="date" value={table11.crsInsertDate164} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateCreaResv165 ? (
                      <TextFormat type="date" value={table11.dateCreaResv165} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.datePremier166 ? (
                      <TextFormat type="date" value={table11.datePremier166} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.statutPremier167}</td>
                  <td>
                    {table11.dateDernier168 ? (
                      <TextFormat type="date" value={table11.dateDernier168} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.statutDernier169}</td>
                  <td>
                    {table11.dateDernierPseudo170 ? (
                      <TextFormat type="date" value={table11.dateDernierPseudo170} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.statutDernierPseudo171}</td>
                  <td>{table11.diffDtCreaAnn172}</td>
                  <td>{table11.diffDtArrAnn173}</td>
                  <td>{table11.leadtime174}</td>
                  <td>{table11.los175}</td>
                  <td>{table11.occupantsGroupe176}</td>
                  <td>{table11.nbNuitee177}</td>
                  <td>{table11.nbNuiteeNnDed178}</td>
                  <td>{table11.nbResvAnn179}</td>
                  <td>{table11.nbAdu180}</td>
                  <td>{table11.nbEnf181}</td>
                  <td>{table11.nbPersDayU182}</td>
                  <td>{table11.nbPersArr183}</td>
                  <td>{table11.nbPersDep184}</td>
                  <td>{table11.nbPersAnn185}</td>
                  <td>{table11.nbPersNoshow186}</td>
                  <td>{table11.nbChbDayU187}</td>
                  <td>{table11.nbChbArr188}</td>
                  <td>{table11.nbChbDep189}</td>
                  <td>{table11.nbChbAnn190}</td>
                  <td>{table11.nbChbNoshow191}</td>
                  <td>{table11.revenuNetChambre192}</td>
                  <td>{table11.revenuTaxeChambre193}</td>
                  <td>{table11.revenuNetChambreGlobal194}</td>
                  <td>{table11.revenuTaxeChambreGlobal195}</td>
                  <td>{table11.revenuNetBq196}</td>
                  <td>{table11.revenuTaxeBq197}</td>
                  <td>{table11.revenuNetBqGlobal198}</td>
                  <td>{table11.revenuTaxeBqGlobal199}</td>
                  <td>{table11.revenuNetExtra200}</td>
                  <td>{table11.revenuTaxeExtra201}</td>
                  <td>{table11.revenuNetExtraGlobal202}</td>
                  <td>{table11.revenuTaxeExtraGlobal203}</td>
                  <td>{table11.revenuNetTotal204}</td>
                  <td>{table11.revenuTaxeTotal205}</td>
                  <td>{table11.revenuNetTotalGlobal206}</td>
                  <td>{table11.revenuTaxeTotalGlobal207}</td>
                  <td>{table11.prodRevenuChambre208}</td>
                  <td>{table11.prodRevenuBq209}</td>
                  <td>{table11.prodRevenuExtra210}</td>
                  <td>{table11.prodRevenuTotal211}</td>
                  <td>{table11.prodChambreNbNuitees212}</td>
                  <td>
                    {table11.techCreateDate213 ? (
                      <TextFormat type="date" value={table11.techCreateDate213} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.techUpdateDate214 ? (
                      <TextFormat type="date" value={table11.techUpdateDate214} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.numLigne215}</td>
                  <td>{table11.resort216}</td>
                  <td>{table11.resvNameId217}</td>
                  <td>{table11.clientOId218}</td>
                  <td>{table11.typeChb219}</td>
                  <td>{table11.confirmationNo220}</td>
                  <td>{table11.clientMdmId221}</td>
                  <td>{table11.nameId222}</td>
                  <td>{table11.parentResvNameId223}</td>
                  <td>{table11.contactId224}</td>
                  <td>{table11.agenceId225}</td>
                  <td>{table11.agenceNom226}</td>
                  <td>{table11.societeId227}</td>
                  <td>{table11.groupeId228}</td>
                  <td>{table11.numBloc229}</td>
                  <td>{table11.typeResv230}</td>
                  <td>{table11.statutResv231}</td>
                  <td>
                    {table11.dateDebutResv232 ? (
                      <TextFormat type="date" value={table11.dateDebutResv232} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateFinResv233 ? (
                      <TextFormat type="date" value={table11.dateFinResv233} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.truncDateDebutResv234 ? (
                      <TextFormat type="date" value={table11.truncDateDebutResv234} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.truncDateFinResv235 ? (
                      <TextFormat type="date" value={table11.truncDateFinResv235} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateAnnResv236 ? (
                      <TextFormat type="date" value={table11.dateAnnResv236} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.pseudoRoomYn237}</td>
                  <td>{table11.createurResv238}</td>
                  <td>{table11.nomCreateurResv239}</td>
                  <td>{table11.codeGarantie240}</td>
                  <td>{table11.flgDed241}</td>
                  <td>{table11.codePays242}</td>
                  <td>{table11.libPays243}</td>
                  <td>{table11.codeNationalite244}</td>
                  <td>{table11.libNationalite245}</td>
                  <td>{table11.codeSource246}</td>
                  <td>{table11.libSource247}</td>
                  <td>{table11.codeGrandSource248}</td>
                  <td>{table11.codeOrigine249}</td>
                  <td>{table11.libOrigine250}</td>
                  <td>{table11.codeMarche251}</td>
                  <td>{table11.libMarche252}</td>
                  <td>{table11.codeGrandMarche253}</td>
                  <td>{table11.libGrandMarche254}</td>
                  <td>{table11.codePrix255}</td>
                  <td>{table11.categPrix256}</td>
                  <td>{table11.libPrix257}</td>
                  <td>{table11.numChb258}</td>
                  <td>{table11.descriptionTypeChb259}</td>
                  <td>{table11.codeTypeChb260}</td>
                  <td>{table11.classChb261}</td>
                  <td>{table11.caractChb262}</td>
                  <td>{table11.typeChbDeReservation263}</td>
                  <td>{table11.descriptionTypeChbDeResv264}</td>
                  <td>{table11.codeTypeChbDeResv265}</td>
                  <td>{table11.statutDeReservation266}</td>
                  <td>{table11.circuitDistribution267}</td>
                  <td>{table11.circuitDistribUserRegroup268}</td>
                  <td>{table11.numCrs269}</td>
                  <td>{table11.typeRefCrs270}</td>
                  <td>
                    {table11.crsInsertDate271 ? (
                      <TextFormat type="date" value={table11.crsInsertDate271} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.dateCreaResv272 ? (
                      <TextFormat type="date" value={table11.dateCreaResv272} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table11.datePremier273 ? (
                      <TextFormat type="date" value={table11.datePremier273} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.statutPremier274}</td>
                  <td>
                    {table11.dateDernier275 ? (
                      <TextFormat type="date" value={table11.dateDernier275} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.statutDernier276}</td>
                  <td>
                    {table11.dateDernierPseudo277 ? (
                      <TextFormat type="date" value={table11.dateDernierPseudo277} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table11.statutDernierPseudo278}</td>
                  <td>{table11.diffDtCreaAnn279}</td>
                  <td>{table11.diffDtArrAnn280}</td>
                  <td>{table11.leadtime281}</td>
                  <td>{table11.los282}</td>
                  <td>{table11.occupantsGroupe283}</td>
                  <td>{table11.nbNuitee284}</td>
                  <td>{table11.nbNuiteeNnDed285}</td>
                  <td>{table11.nbResvAnn286}</td>
                  <td>{table11.nbAdu287}</td>
                  <td>{table11.nbEnf288}</td>
                  <td>{table11.nbPersDayU289}</td>
                  <td>{table11.nbPersArr290}</td>
                  <td>{table11.nbPersDep291}</td>
                  <td>{table11.nbPersAnn292}</td>
                  <td>{table11.nbPersNoshow293}</td>
                  <td>{table11.nbChbDayU294}</td>
                  <td>{table11.nbChbArr295}</td>
                  <td>{table11.nbChbDep296}</td>
                  <td>{table11.nbChbAnn297}</td>
                  <td>{table11.nbChbNoshow298}</td>
                  <td>{table11.revenuNetChambre299}</td>
                  <td>{table11.revenuTaxeChambre300}</td>
                  <td>{table11.revenuNetChambreGlobal301}</td>
                  <td>{table11.revenuTaxeChambreGlobal302}</td>
                  <td>{table11.revenuNetBq303}</td>
                  <td>{table11.revenuTaxeBq304}</td>
                  <td>{table11.revenuNetBqGlobal305}</td>
                  <td>{table11.revenuTaxeBqGlobal306}</td>
                  <td>{table11.revenuNetExtra307}</td>
                  <td>{table11.revenuTaxeExtra308}</td>
                  <td>{table11.revenuNetExtraGlobal309}</td>
                  <td>{table11.revenuTaxeExtraGlobal310}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/table-11/${table11.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/table-11/${table11.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/table-11/${table11.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table11.home.notFound">No Table 11 S found</Translate>
            </div>
          )
        )}
      </div>
