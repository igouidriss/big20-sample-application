...
export const Table6DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="big20SampleApplicationApp.table6.delete.question">
        <Translate contentKey="big20SampleApplicationApp.table6.delete.question" interpolate={{ id: table6Entity.id }}>
