...
import { getEntities } from './table-20.reducer';
...
export const Table20 = () => {
  ...
  const table20List = useAppSelector(state => state.table20.entities);
  ...
  return (
    <div>
      <h2 id="table-20-heading" data-cy="Table20Heading">
        <Translate contentKey="big20SampleApplicationApp.table20.home.title">Table 20 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table20.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-20/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table20.home.createLabel">Create new Table 20</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {table20List && table20List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table20.revenuTaxeExtraGlobal310">
            ...
            <tbody>
              {table20List.map((table20, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/table-20/${table20.id}`} color="link" size="sm">
                      {table20.id}
                    </Button>
                  </td>
                  <td>{table20.numLigne1}</td>
                  <td>{table20.resort2}</td>
                  <td>{table20.resvNameId3}</td>
                  <td>{table20.clientOId4}</td>
                  <td>{table20.typeChb5}</td>
                  <td>{table20.confirmationNo6}</td>
                  <td>{table20.clientMdmId7}</td>
                  <td>{table20.nameId8}</td>
                  <td>{table20.parentResvNameId9}</td>
                  <td>{table20.contactId10}</td>
                  <td>{table20.agenceId11}</td>
                  <td>{table20.agenceNom12}</td>
                  <td>{table20.societeId13}</td>
                  <td>{table20.groupeId14}</td>
                  <td>{table20.numBloc15}</td>
                  <td>{table20.typeResv16}</td>
                  <td>{table20.statutResv17}</td>
                  <td>
                    {table20.dateDebutResv18 ? (
                      <TextFormat type="date" value={table20.dateDebutResv18} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateFinResv19 ? <TextFormat type="date" value={table20.dateFinResv19} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {table20.truncDateDebutResv20 ? (
                      <TextFormat type="date" value={table20.truncDateDebutResv20} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.truncDateFinResv21 ? (
                      <TextFormat type="date" value={table20.truncDateFinResv21} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateAnnResv22 ? <TextFormat type="date" value={table20.dateAnnResv22} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table20.pseudoRoomYn23}</td>
                  <td>{table20.createurResv24}</td>
                  <td>{table20.nomCreateurResv25}</td>
                  <td>{table20.codeGarantie26}</td>
                  <td>{table20.flgDed27}</td>
                  <td>{table20.codePays28}</td>
                  <td>{table20.libPays29}</td>
                  <td>{table20.codeNationalite30}</td>
                  <td>{table20.libNationalite31}</td>
                  <td>{table20.codeSource32}</td>
                  <td>{table20.libSource33}</td>
                  <td>{table20.codeGrandSource34}</td>
                  <td>{table20.codeOrigine35}</td>
                  <td>{table20.libOrigine36}</td>
                  <td>{table20.codeMarche37}</td>
                  <td>{table20.libMarche38}</td>
                  <td>{table20.codeGrandMarche39}</td>
                  <td>{table20.libGrandMarche40}</td>
                  <td>{table20.codePrix41}</td>
                  <td>{table20.categPrix42}</td>
                  <td>{table20.libPrix43}</td>
                  <td>{table20.numChb44}</td>
                  <td>{table20.descriptionTypeChb45}</td>
                  <td>{table20.codeTypeChb46}</td>
                  <td>{table20.classChb47}</td>
                  <td>{table20.caractChb48}</td>
                  <td>{table20.typeChbDeReservation49}</td>
                  <td>{table20.descriptionTypeChbDeResv50}</td>
                  <td>{table20.codeTypeChbDeResv51}</td>
                  <td>{table20.statutDeReservation52}</td>
                  <td>{table20.circuitDistribution53}</td>
                  <td>{table20.circuitDistribUserRegroup54}</td>
                  <td>{table20.numCrs55}</td>
                  <td>{table20.typeRefCrs56}</td>
                  <td>
                    {table20.crsInsertDate57 ? (
                      <TextFormat type="date" value={table20.crsInsertDate57} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateCreaResv58 ? (
                      <TextFormat type="date" value={table20.dateCreaResv58} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.datePremier59 ? <TextFormat type="date" value={table20.datePremier59} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table20.statutPremier60}</td>
                  <td>
                    {table20.dateDernier61 ? <TextFormat type="date" value={table20.dateDernier61} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>{table20.statutDernier62}</td>
                  <td>
                    {table20.dateDernierPseudo63 ? (
                      <TextFormat type="date" value={table20.dateDernierPseudo63} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.statutDernierPseudo64}</td>
                  <td>{table20.diffDtCreaAnn65}</td>
                  <td>{table20.diffDtArrAnn66}</td>
                  <td>{table20.leadtime67}</td>
                  <td>{table20.los68}</td>
                  <td>{table20.occupantsGroupe69}</td>
                  <td>{table20.nbNuitee70}</td>
                  <td>{table20.nbNuiteeNnDed71}</td>
                  <td>{table20.nbResvAnn72}</td>
                  <td>{table20.nbAdu73}</td>
                  <td>{table20.nbEnf74}</td>
                  <td>{table20.nbPersDayU75}</td>
                  <td>{table20.nbPersArr76}</td>
                  <td>{table20.nbPersDep77}</td>
                  <td>{table20.nbPersAnn78}</td>
                  <td>{table20.nbPersNoshow79}</td>
                  <td>{table20.nbChbDayU80}</td>
                  <td>{table20.nbChbArr81}</td>
                  <td>{table20.nbChbDep82}</td>
                  <td>{table20.nbChbAnn83}</td>
                  <td>{table20.nbChbNoshow84}</td>
                  <td>{table20.revenuNetChambre85}</td>
                  <td>{table20.revenuTaxeChambre86}</td>
                  <td>{table20.revenuNetChambreGlobal87}</td>
                  <td>{table20.revenuTaxeChambreGlobal88}</td>
                  <td>{table20.revenuNetBq89}</td>
                  <td>{table20.revenuTaxeBq90}</td>
                  <td>{table20.revenuNetBqGlobal91}</td>
                  <td>{table20.revenuTaxeBqGlobal92}</td>
                  <td>{table20.revenuNetExtra93}</td>
                  <td>{table20.revenuTaxeExtra94}</td>
                  <td>{table20.revenuNetExtraGlobal95}</td>
                  <td>{table20.revenuTaxeExtraGlobal96}</td>
                  <td>{table20.revenuNetTotal97}</td>
                  <td>{table20.revenuTaxeTotal98}</td>
                  <td>{table20.revenuNetTotalGlobal99}</td>
                  <td>{table20.revenuTaxeTotalGlobal100}</td>
                  <td>{table20.prodRevenuChambre101}</td>
                  <td>{table20.prodRevenuBq102}</td>
                  <td>{table20.prodRevenuExtra103}</td>
                  <td>{table20.prodRevenuTotal104}</td>
                  <td>{table20.prodChambreNbNuitees105}</td>
                  <td>
                    {table20.techCreateDate106 ? (
                      <TextFormat type="date" value={table20.techCreateDate106} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.techUpdateDate107 ? (
                      <TextFormat type="date" value={table20.techUpdateDate107} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.numLigne108}</td>
                  <td>{table20.resort109}</td>
                  <td>{table20.resvNameId110}</td>
                  <td>{table20.clientOId111}</td>
                  <td>{table20.typeChb112}</td>
                  <td>{table20.confirmationNo113}</td>
                  <td>{table20.clientMdmId114}</td>
                  <td>{table20.nameId115}</td>
                  <td>{table20.parentResvNameId116}</td>
                  <td>{table20.contactId117}</td>
                  <td>{table20.agenceId118}</td>
                  <td>{table20.agenceNom119}</td>
                  <td>{table20.societeId120}</td>
                  <td>{table20.groupeId121}</td>
                  <td>{table20.numBloc122}</td>
                  <td>{table20.typeResv123}</td>
                  <td>{table20.statutResv124}</td>
                  <td>
                    {table20.dateDebutResv125 ? (
                      <TextFormat type="date" value={table20.dateDebutResv125} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateFinResv126 ? (
                      <TextFormat type="date" value={table20.dateFinResv126} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.truncDateDebutResv127 ? (
                      <TextFormat type="date" value={table20.truncDateDebutResv127} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.truncDateFinResv128 ? (
                      <TextFormat type="date" value={table20.truncDateFinResv128} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateAnnResv129 ? (
                      <TextFormat type="date" value={table20.dateAnnResv129} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.pseudoRoomYn130}</td>
                  <td>{table20.createurResv131}</td>
                  <td>{table20.nomCreateurResv132}</td>
                  <td>{table20.codeGarantie133}</td>
                  <td>{table20.flgDed134}</td>
                  <td>{table20.codePays135}</td>
                  <td>{table20.libPays136}</td>
                  <td>{table20.codeNationalite137}</td>
                  <td>{table20.libNationalite138}</td>
                  <td>{table20.codeSource139}</td>
                  <td>{table20.libSource140}</td>
                  <td>{table20.codeGrandSource141}</td>
                  <td>{table20.codeOrigine142}</td>
                  <td>{table20.libOrigine143}</td>
                  <td>{table20.codeMarche144}</td>
                  <td>{table20.libMarche145}</td>
                  <td>{table20.codeGrandMarche146}</td>
                  <td>{table20.libGrandMarche147}</td>
                  <td>{table20.codePrix148}</td>
                  <td>{table20.categPrix149}</td>
                  <td>{table20.libPrix150}</td>
                  <td>{table20.numChb151}</td>
                  <td>{table20.descriptionTypeChb152}</td>
                  <td>{table20.codeTypeChb153}</td>
                  <td>{table20.classChb154}</td>
                  <td>{table20.caractChb155}</td>
                  <td>{table20.typeChbDeReservation156}</td>
                  <td>{table20.descriptionTypeChbDeResv157}</td>
                  <td>{table20.codeTypeChbDeResv158}</td>
                  <td>{table20.statutDeReservation159}</td>
                  <td>{table20.circuitDistribution160}</td>
                  <td>{table20.circuitDistribUserRegroup161}</td>
                  <td>{table20.numCrs162}</td>
                  <td>{table20.typeRefCrs163}</td>
                  <td>
                    {table20.crsInsertDate164 ? (
                      <TextFormat type="date" value={table20.crsInsertDate164} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateCreaResv165 ? (
                      <TextFormat type="date" value={table20.dateCreaResv165} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.datePremier166 ? (
                      <TextFormat type="date" value={table20.datePremier166} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.statutPremier167}</td>
                  <td>
                    {table20.dateDernier168 ? (
                      <TextFormat type="date" value={table20.dateDernier168} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.statutDernier169}</td>
                  <td>
                    {table20.dateDernierPseudo170 ? (
                      <TextFormat type="date" value={table20.dateDernierPseudo170} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.statutDernierPseudo171}</td>
                  <td>{table20.diffDtCreaAnn172}</td>
                  <td>{table20.diffDtArrAnn173}</td>
                  <td>{table20.leadtime174}</td>
                  <td>{table20.los175}</td>
                  <td>{table20.occupantsGroupe176}</td>
                  <td>{table20.nbNuitee177}</td>
                  <td>{table20.nbNuiteeNnDed178}</td>
                  <td>{table20.nbResvAnn179}</td>
                  <td>{table20.nbAdu180}</td>
                  <td>{table20.nbEnf181}</td>
                  <td>{table20.nbPersDayU182}</td>
                  <td>{table20.nbPersArr183}</td>
                  <td>{table20.nbPersDep184}</td>
                  <td>{table20.nbPersAnn185}</td>
                  <td>{table20.nbPersNoshow186}</td>
                  <td>{table20.nbChbDayU187}</td>
                  <td>{table20.nbChbArr188}</td>
                  <td>{table20.nbChbDep189}</td>
                  <td>{table20.nbChbAnn190}</td>
                  <td>{table20.nbChbNoshow191}</td>
                  <td>{table20.revenuNetChambre192}</td>
                  <td>{table20.revenuTaxeChambre193}</td>
                  <td>{table20.revenuNetChambreGlobal194}</td>
                  <td>{table20.revenuTaxeChambreGlobal195}</td>
                  <td>{table20.revenuNetBq196}</td>
                  <td>{table20.revenuTaxeBq197}</td>
                  <td>{table20.revenuNetBqGlobal198}</td>
                  <td>{table20.revenuTaxeBqGlobal199}</td>
                  <td>{table20.revenuNetExtra200}</td>
                  <td>{table20.revenuTaxeExtra201}</td>
                  <td>{table20.revenuNetExtraGlobal202}</td>
                  <td>{table20.revenuTaxeExtraGlobal203}</td>
                  <td>{table20.revenuNetTotal204}</td>
                  <td>{table20.revenuTaxeTotal205}</td>
                  <td>{table20.revenuNetTotalGlobal206}</td>
                  <td>{table20.revenuTaxeTotalGlobal207}</td>
                  <td>{table20.prodRevenuChambre208}</td>
                  <td>{table20.prodRevenuBq209}</td>
                  <td>{table20.prodRevenuExtra210}</td>
                  <td>{table20.prodRevenuTotal211}</td>
                  <td>{table20.prodChambreNbNuitees212}</td>
                  <td>
                    {table20.techCreateDate213 ? (
                      <TextFormat type="date" value={table20.techCreateDate213} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.techUpdateDate214 ? (
                      <TextFormat type="date" value={table20.techUpdateDate214} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.numLigne215}</td>
                  <td>{table20.resort216}</td>
                  <td>{table20.resvNameId217}</td>
                  <td>{table20.clientOId218}</td>
                  <td>{table20.typeChb219}</td>
                  <td>{table20.confirmationNo220}</td>
                  <td>{table20.clientMdmId221}</td>
                  <td>{table20.nameId222}</td>
                  <td>{table20.parentResvNameId223}</td>
                  <td>{table20.contactId224}</td>
                  <td>{table20.agenceId225}</td>
                  <td>{table20.agenceNom226}</td>
                  <td>{table20.societeId227}</td>
                  <td>{table20.groupeId228}</td>
                  <td>{table20.numBloc229}</td>
                  <td>{table20.typeResv230}</td>
                  <td>{table20.statutResv231}</td>
                  <td>
                    {table20.dateDebutResv232 ? (
                      <TextFormat type="date" value={table20.dateDebutResv232} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateFinResv233 ? (
                      <TextFormat type="date" value={table20.dateFinResv233} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.truncDateDebutResv234 ? (
                      <TextFormat type="date" value={table20.truncDateDebutResv234} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.truncDateFinResv235 ? (
                      <TextFormat type="date" value={table20.truncDateFinResv235} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateAnnResv236 ? (
                      <TextFormat type="date" value={table20.dateAnnResv236} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.pseudoRoomYn237}</td>
                  <td>{table20.createurResv238}</td>
                  <td>{table20.nomCreateurResv239}</td>
                  <td>{table20.codeGarantie240}</td>
                  <td>{table20.flgDed241}</td>
                  <td>{table20.codePays242}</td>
                  <td>{table20.libPays243}</td>
                  <td>{table20.codeNationalite244}</td>
                  <td>{table20.libNationalite245}</td>
                  <td>{table20.codeSource246}</td>
                  <td>{table20.libSource247}</td>
                  <td>{table20.codeGrandSource248}</td>
                  <td>{table20.codeOrigine249}</td>
                  <td>{table20.libOrigine250}</td>
                  <td>{table20.codeMarche251}</td>
                  <td>{table20.libMarche252}</td>
                  <td>{table20.codeGrandMarche253}</td>
                  <td>{table20.libGrandMarche254}</td>
                  <td>{table20.codePrix255}</td>
                  <td>{table20.categPrix256}</td>
                  <td>{table20.libPrix257}</td>
                  <td>{table20.numChb258}</td>
                  <td>{table20.descriptionTypeChb259}</td>
                  <td>{table20.codeTypeChb260}</td>
                  <td>{table20.classChb261}</td>
                  <td>{table20.caractChb262}</td>
                  <td>{table20.typeChbDeReservation263}</td>
                  <td>{table20.descriptionTypeChbDeResv264}</td>
                  <td>{table20.codeTypeChbDeResv265}</td>
                  <td>{table20.statutDeReservation266}</td>
                  <td>{table20.circuitDistribution267}</td>
                  <td>{table20.circuitDistribUserRegroup268}</td>
                  <td>{table20.numCrs269}</td>
                  <td>{table20.typeRefCrs270}</td>
                  <td>
                    {table20.crsInsertDate271 ? (
                      <TextFormat type="date" value={table20.crsInsertDate271} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.dateCreaResv272 ? (
                      <TextFormat type="date" value={table20.dateCreaResv272} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {table20.datePremier273 ? (
                      <TextFormat type="date" value={table20.datePremier273} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.statutPremier274}</td>
                  <td>
                    {table20.dateDernier275 ? (
                      <TextFormat type="date" value={table20.dateDernier275} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.statutDernier276}</td>
                  <td>
                    {table20.dateDernierPseudo277 ? (
                      <TextFormat type="date" value={table20.dateDernierPseudo277} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{table20.statutDernierPseudo278}</td>
                  <td>{table20.diffDtCreaAnn279}</td>
                  <td>{table20.diffDtArrAnn280}</td>
                  <td>{table20.leadtime281}</td>
                  <td>{table20.los282}</td>
                  <td>{table20.occupantsGroupe283}</td>
                  <td>{table20.nbNuitee284}</td>
                  <td>{table20.nbNuiteeNnDed285}</td>
                  <td>{table20.nbResvAnn286}</td>
                  <td>{table20.nbAdu287}</td>
                  <td>{table20.nbEnf288}</td>
                  <td>{table20.nbPersDayU289}</td>
                  <td>{table20.nbPersArr290}</td>
                  <td>{table20.nbPersDep291}</td>
                  <td>{table20.nbPersAnn292}</td>
                  <td>{table20.nbPersNoshow293}</td>
                  <td>{table20.nbChbDayU294}</td>
                  <td>{table20.nbChbArr295}</td>
                  <td>{table20.nbChbDep296}</td>
                  <td>{table20.nbChbAnn297}</td>
                  <td>{table20.nbChbNoshow298}</td>
                  <td>{table20.revenuNetChambre299}</td>
                  <td>{table20.revenuTaxeChambre300}</td>
                  <td>{table20.revenuNetChambreGlobal301}</td>
                  <td>{table20.revenuTaxeChambreGlobal302}</td>
                  <td>{table20.revenuNetBq303}</td>
                  <td>{table20.revenuTaxeBq304}</td>
                  <td>{table20.revenuNetBqGlobal305}</td>
                  <td>{table20.revenuTaxeBqGlobal306}</td>
                  <td>{table20.revenuNetExtra307}</td>
                  <td>{table20.revenuTaxeExtra308}</td>
                  <td>{table20.revenuNetExtraGlobal309}</td>
                  <td>{table20.revenuTaxeExtraGlobal310}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/table-20/${table20.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/table-20/${table20.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/table-20/${table20.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table20.home.notFound">No Table 20 S found</Translate>
            </div>
          )
        )}
      </div>
