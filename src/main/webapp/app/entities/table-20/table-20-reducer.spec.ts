...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './table-20.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLE20_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TABLE20 actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TABLE20 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TABLE20 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TABLE20 actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TABLE20 actions', async () => {
      const arg = 42666;
