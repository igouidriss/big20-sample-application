  ...
  return (
    <div>
      <h2 id="table-10-heading" data-cy="Table10Heading">
        <Translate contentKey="big20SampleApplicationApp.table10.home.title">Table 10 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="big20SampleApplicationApp.table10.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-10/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="big20SampleApplicationApp.table10.home.createLabel">Create new Table 10</Translate>
          </Link>
        </div>
      </h2>
        ...
        {table10List && table10List.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal87')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuNetChambreGlobal87">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal194')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuNetChambreGlobal194">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('revenuNetChambreGlobal301')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuNetChambreGlobal301">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="big20SampleApplicationApp.table10.revenuTaxeExtraGlobal310">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="big20SampleApplicationApp.table10.home.notFound">No Table 10 S found</Translate>
            </div>
          )
        )}
      </div>
