...
public class Table20TestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static Table20 getTable20Sample1() {
        return new Table20()
            .id(1L)
            .numLigne1(1)
            .resort2("resort21")
    ...
    public static Table20 getTable20Sample2() {
        return new Table20()
            .id(2L)
            .numLigne1(2)
            .resort2("resort22")
    ...
    public static Table20 getTable20RandomSampleGenerator() {
        return new Table20()
