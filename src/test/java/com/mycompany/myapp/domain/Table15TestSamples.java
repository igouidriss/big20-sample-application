...
public class Table15TestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static Table15 getTable15Sample1() {
        return new Table15()
            .id(1L)
            .numLigne1(1)
            .resort2("resort21")
    ...
    public static Table15 getTable15Sample2() {
        return new Table15()
            .id(2L)
            .numLigne1(2)
            .resort2("resort22")
    ...
    public static Table15 getTable15RandomSampleGenerator() {
        return new Table15()
