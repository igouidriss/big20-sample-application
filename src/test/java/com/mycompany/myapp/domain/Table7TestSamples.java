...
public class Table7TestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static Table7 getTable7Sample1() {
        return new Table7()
            .id(1L)
            .numLigne1(1)
            .resort2("resort21")
    ...
    public static Table7 getTable7Sample2() {
        return new Table7()
            .id(2L)
            .numLigne1(2)
            .resort2("resort22")
    ...
    public static Table7 getTable7RandomSampleGenerator() {
        return new Table7()
