...
public class Table12TestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static Table12 getTable12Sample1() {
        return new Table12()
            .id(1L)
            .numLigne1(1)
            .resort2("resort21")
    ...
    public static Table12 getTable12Sample2() {
        return new Table12()
            .id(2L)
            .numLigne1(2)
            .resort2("resort22")
    ...
    public static Table12 getTable12RandomSampleGenerator() {
        return new Table12()
